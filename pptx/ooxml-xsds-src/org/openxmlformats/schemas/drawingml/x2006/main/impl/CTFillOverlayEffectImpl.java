 ...
 */
public class CTFillOverlayEffectImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.main.CTFillOverlayEffect
{
    
    public CTFillOverlayEffectImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName BLEND$12 = 
    ...
    public org.openxmlformats.schemas.drawingml.x2006.main.STBlendMode.Enum getBlend()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(BLEND$12);
            if (target == null)
            {
                return null;
            }
    ...
    public org.openxmlformats.schemas.drawingml.x2006.main.STBlendMode xgetBlend()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.main.STBlendMode)get_store().find_attribute_user(BLEND$12);
            return target;
        }
    }
    ...
    public void setBlend(org.openxmlformats.schemas.drawingml.x2006.main.STBlendMode.Enum blend)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(BLEND$12);
            }
    ...
    public void xsetBlend(org.openxmlformats.schemas.drawingml.x2006.main.STBlendMode blend)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.main.STBlendMode)get_store().add_attribute_user(BLEND$12);
            }
            target.set(blend);
        }
    }
