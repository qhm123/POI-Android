 ...
 */
public class CTCustomColorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.main.CTCustomColor
{
    
    public CTCustomColorImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public java.lang.String getName()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(NAME$12);
            }
            if (target == null)
            {
                return null;
    ...
    public org.apache.xmlbeans.XmlString xgetName()
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_default_attribute_value(NAME$12);
            }
            return target;
        }
    }
