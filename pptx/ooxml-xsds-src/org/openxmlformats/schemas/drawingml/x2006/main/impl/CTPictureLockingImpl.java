...
public class CTPictureLockingImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.main.CTPictureLocking
{
    ...
    public boolean getNoCrop()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(NOCROP$22);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(NOCROP$22);
            }
            if (target == null)
            {
                return false;
    ...
    public org.apache.xmlbeans.XmlBoolean xgetNoCrop()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlBoolean target = null;
            target = (org.apache.xmlbeans.XmlBoolean)get_store().find_attribute_user(NOCROP$22);
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_default_attribute_value(NOCROP$22);
            }
            return target;
        }
    }
    ...
    public void setNoCrop(boolean noCrop)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(NOCROP$22);
            }
    ...
    public void xsetNoCrop(org.apache.xmlbeans.XmlBoolean noCrop)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_store().add_attribute_user(NOCROP$22);
            }
            target.set(noCrop);
        }
    }
