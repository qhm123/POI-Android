 ...
 */
public class CTSlideIdListEntryImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.presentationml.x2006.main.CTSlideIdListEntry
{
    
    public CTSlideIdListEntryImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.openxmlformats.schemas.presentationml.x2006.main.STSlideId xgetId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.presentationml.x2006.main.STSlideId target = null;
            target = (org.openxmlformats.schemas.presentationml.x2006.main.STSlideId)get_store().find_attribute_user(ID$2);
            return target;
        }
    }
     ...
     */
    public void xsetId(org.openxmlformats.schemas.presentationml.x2006.main.STSlideId id)
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public java.lang.String getId2()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ID2$4);
            if (target == null)
            {
                return null;
            }
    ...
    public org.openxmlformats.schemas.officeDocument.x2006.relationships.STRelationshipId xgetId2()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openxmlformats.schemas.officeDocument.x2006.relationships.STRelationshipId)get_store().find_attribute_user(ID2$4);
            return target;
        }
    }
    ...
    public void setId2(java.lang.String id2)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ID2$4);
            }
    ...
    public void xsetId2(org.openxmlformats.schemas.officeDocument.x2006.relationships.STRelationshipId id2)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.officeDocument.x2006.relationships.STRelationshipId)get_store().add_attribute_user(ID2$4);
            }
            target.set(id2);
        }
    }
