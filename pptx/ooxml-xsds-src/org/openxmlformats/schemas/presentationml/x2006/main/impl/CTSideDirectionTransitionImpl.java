...
public class CTSideDirectionTransitionImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.presentationml.x2006.main.CTSideDirectionTransition
{
    ...
    public org.openxmlformats.schemas.presentationml.x2006.main.STTransitionSideDirectionType.Enum getDir()
    {
        synchronized (monitor())
        {
            ...
            return (org.openxmlformats.schemas.presentationml.x2006.main.STTransitionSideDirectionType.Enum)target.getEnumValue();
        }
    }
    ...
    public org.openxmlformats.schemas.presentationml.x2006.main.STTransitionSideDirectionType xgetDir()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openxmlformats.schemas.presentationml.x2006.main.STTransitionSideDirectionType)get_store().find_attribute_user(DIR$0);
            if (target == null)
            {
                target = (org.openxmlformats.schemas.presentationml.x2006.main.STTransitionSideDirectionType)get_default_attribute_value(DIR$0);
            }
            return target;
        }
    }
    ...
    public void xsetDir(org.openxmlformats.schemas.presentationml.x2006.main.STTransitionSideDirectionType dir)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.presentationml.x2006.main.STTransitionSideDirectionType)get_store().add_attribute_user(DIR$0);
            }
            target.set(dir);
        }
    }
