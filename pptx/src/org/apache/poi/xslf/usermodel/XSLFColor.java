...
/**
 * Encapsulates logic to read color definitions from DrawingML and convert them to and.awt.Color
 *
 * @author Yegor Kozlov
 */
@Beta
    ...
    Color toColor(XmlObject obj, XSLFTheme theme) {
        ...
        for (XmlObject ch : obj.selectPath("*")) {
            if (ch instanceof CTHslColor) {
                ...
                // find referenced CTColor in the theme and convert it to and.awt.Color via a recursive call
