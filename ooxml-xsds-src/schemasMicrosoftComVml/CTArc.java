 ...
 */
public interface CTArc extends org.apache.xmlbeans.XmlObject
{
    public static final org.apache.xmlbeans.SchemaType type = (org.apache.xmlbeans.SchemaType)
        org.apache.xmlbeans.XmlBeans.typeSystemForClassLoader(CTArc.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("ctarcee66type");
    
    /**
     * Gets a List of "path" elements
     */
    java.util.List<schemasMicrosoftComVml.CTPath> getPathList();
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTFormulas> getFormulasList();
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTHandles> getHandlesList();
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTFill> getFillList();
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTStroke> getStrokeList();
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTShadow> getShadowList();
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTTextbox> getTextboxList();
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTTextPath> getTextpathList();
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTImageData> getImagedataList();
     ...
     */
    java.util.List<schemasMicrosoftComOfficeOffice.CTSkew> getSkewList();
     ...
     */
    java.util.List<schemasMicrosoftComOfficeOffice.CTExtrusion> getExtrusionList();
     ...
     */
    java.util.List<schemasMicrosoftComOfficeOffice.CTCallout> getCalloutList();
     ...
     */
    java.util.List<schemasMicrosoftComOfficeOffice.CTLock> getLockList();
     ...
     */
    java.util.List<schemasMicrosoftComOfficeOffice.CTClipPath> getClippathList();
     ...
     */
    java.util.List<schemasMicrosoftComOfficeOffice.CTSignatureLine> getSignaturelineList();
     ...
     */
    java.util.List<schemasMicrosoftComOfficeWord.CTWrap> getWrapList();
     ...
     */
    java.util.List<schemasMicrosoftComOfficeWord.CTAnchorLock> getAnchorlockList();
     ...
     */
    java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBordertopList();
     ...
     */
    java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderbottomList();
     ...
     */
    java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderleftList();
     ...
     */
    java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderrightList();
     ...
     */
    java.util.List<schemasMicrosoftComOfficeExcel.CTClientData> getClientDataList();
     ...
     */
    java.util.List<schemasMicrosoftComOfficePowerpoint.CTRel> getTextdataList();
     ...
     */
    java.math.BigDecimal getStartAngle();
    
    /**
     * Gets (as xml) the "startAngle" attribute
     */
    org.apache.xmlbeans.XmlDecimal xgetStartAngle();
     ...
     */
    void setStartAngle(java.math.BigDecimal startAngle);
    
    /**
     * Sets (as xml) the "startAngle" attribute
     */
    void xsetStartAngle(org.apache.xmlbeans.XmlDecimal startAngle);
     ...
     */
    java.math.BigDecimal getEndAngle();
    
    /**
     * Gets (as xml) the "endAngle" attribute
     */
    org.apache.xmlbeans.XmlDecimal xgetEndAngle();
     ...
     */
    void setEndAngle(java.math.BigDecimal endAngle);
    
    /**
     * Sets (as xml) the "endAngle" attribute
     */
    void xsetEndAngle(org.apache.xmlbeans.XmlDecimal endAngle);
