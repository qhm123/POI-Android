 ...
 * Java type: schemasMicrosoftComVml.CTImage
 *
 * Automatically generated - do not modify.
 */
package schemasMicrosoftComVml.impl;
/**
 * An XML CT_Image(@urn:schemas-microsoft-com:vml).
 *
 * This is a complex type.
 */
public class CTImageImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements schemasMicrosoftComVml.CTImage
{
    
    public CTImageImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName SRC$152 = 
        new javax.xml.namespace.QName("", "src");
    private static final javax.xml.namespace.QName CROPLEFT$154 = 
        new javax.xml.namespace.QName("", "cropleft");
    private static final javax.xml.namespace.QName CROPTOP$156 = 
        new javax.xml.namespace.QName("", "croptop");
    private static final javax.xml.namespace.QName CROPRIGHT$158 = 
        new javax.xml.namespace.QName("", "cropright");
    private static final javax.xml.namespace.QName CROPBOTTOM$160 = 
        new javax.xml.namespace.QName("", "cropbottom");
    private static final javax.xml.namespace.QName GAIN$162 = 
        new javax.xml.namespace.QName("", "gain");
    private static final javax.xml.namespace.QName BLACKLEVEL$164 = 
        new javax.xml.namespace.QName("", "blacklevel");
    private static final javax.xml.namespace.QName GAMMA$166 = 
        new javax.xml.namespace.QName("", "gamma");
    private static final javax.xml.namespace.QName GRAYSCALE$168 = 
        new javax.xml.namespace.QName("", "grayscale");
    private static final javax.xml.namespace.QName BILEVEL$170 = 
    ...
    public java.util.List<schemasMicrosoftComVml.CTPath> getPathList()
    {
        final class PathList extends java.util.AbstractList<schemasMicrosoftComVml.CTPath>
        {
            public schemasMicrosoftComVml.CTPath get(int i)
                { return CTImageImpl.this.getPathArray(i); }
            
            public schemasMicrosoftComVml.CTPath set(int i, schemasMicrosoftComVml.CTPath o)
            {
                schemasMicrosoftComVml.CTPath old = CTImageImpl.this.getPathArray(i);
                CTImageImpl.this.setPathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTPath o)
                { CTImageImpl.this.insertNewPath(i).set(o); }
            
            public schemasMicrosoftComVml.CTPath remove(int i)
            {
                schemasMicrosoftComVml.CTPath old = CTImageImpl.this.getPathArray(i);
                CTImageImpl.this.removePath(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfPathArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTFormulas> getFormulasList()
    {
        final class FormulasList extends java.util.AbstractList<schemasMicrosoftComVml.CTFormulas>
        {
            public schemasMicrosoftComVml.CTFormulas get(int i)
                { return CTImageImpl.this.getFormulasArray(i); }
            
            public schemasMicrosoftComVml.CTFormulas set(int i, schemasMicrosoftComVml.CTFormulas o)
            {
                schemasMicrosoftComVml.CTFormulas old = CTImageImpl.this.getFormulasArray(i);
                CTImageImpl.this.setFormulasArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTFormulas o)
                { CTImageImpl.this.insertNewFormulas(i).set(o); }
            
            public schemasMicrosoftComVml.CTFormulas remove(int i)
            {
                schemasMicrosoftComVml.CTFormulas old = CTImageImpl.this.getFormulasArray(i);
                CTImageImpl.this.removeFormulas(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfFormulasArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTHandles> getHandlesList()
    {
        final class HandlesList extends java.util.AbstractList<schemasMicrosoftComVml.CTHandles>
        {
            public schemasMicrosoftComVml.CTHandles get(int i)
                { return CTImageImpl.this.getHandlesArray(i); }
            
            public schemasMicrosoftComVml.CTHandles set(int i, schemasMicrosoftComVml.CTHandles o)
            {
                schemasMicrosoftComVml.CTHandles old = CTImageImpl.this.getHandlesArray(i);
                CTImageImpl.this.setHandlesArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTHandles o)
                { CTImageImpl.this.insertNewHandles(i).set(o); }
            
            public schemasMicrosoftComVml.CTHandles remove(int i)
            {
                schemasMicrosoftComVml.CTHandles old = CTImageImpl.this.getHandlesArray(i);
                CTImageImpl.this.removeHandles(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfHandlesArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTFill> getFillList()
    {
        final class FillList extends java.util.AbstractList<schemasMicrosoftComVml.CTFill>
        {
            public schemasMicrosoftComVml.CTFill get(int i)
                { return CTImageImpl.this.getFillArray(i); }
            
            public schemasMicrosoftComVml.CTFill set(int i, schemasMicrosoftComVml.CTFill o)
            {
                schemasMicrosoftComVml.CTFill old = CTImageImpl.this.getFillArray(i);
                CTImageImpl.this.setFillArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTFill o)
                { CTImageImpl.this.insertNewFill(i).set(o); }
            
            public schemasMicrosoftComVml.CTFill remove(int i)
            {
                schemasMicrosoftComVml.CTFill old = CTImageImpl.this.getFillArray(i);
                CTImageImpl.this.removeFill(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfFillArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTStroke> getStrokeList()
    {
        final class StrokeList extends java.util.AbstractList<schemasMicrosoftComVml.CTStroke>
        {
            public schemasMicrosoftComVml.CTStroke get(int i)
                { return CTImageImpl.this.getStrokeArray(i); }
            
            public schemasMicrosoftComVml.CTStroke set(int i, schemasMicrosoftComVml.CTStroke o)
            {
                schemasMicrosoftComVml.CTStroke old = CTImageImpl.this.getStrokeArray(i);
                CTImageImpl.this.setStrokeArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTStroke o)
                { CTImageImpl.this.insertNewStroke(i).set(o); }
            
            public schemasMicrosoftComVml.CTStroke remove(int i)
            {
                schemasMicrosoftComVml.CTStroke old = CTImageImpl.this.getStrokeArray(i);
                CTImageImpl.this.removeStroke(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfStrokeArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTShadow> getShadowList()
    {
        final class ShadowList extends java.util.AbstractList<schemasMicrosoftComVml.CTShadow>
        {
            public schemasMicrosoftComVml.CTShadow get(int i)
                { return CTImageImpl.this.getShadowArray(i); }
            
            public schemasMicrosoftComVml.CTShadow set(int i, schemasMicrosoftComVml.CTShadow o)
            {
                schemasMicrosoftComVml.CTShadow old = CTImageImpl.this.getShadowArray(i);
                CTImageImpl.this.setShadowArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTShadow o)
                { CTImageImpl.this.insertNewShadow(i).set(o); }
            
            public schemasMicrosoftComVml.CTShadow remove(int i)
            {
                schemasMicrosoftComVml.CTShadow old = CTImageImpl.this.getShadowArray(i);
                CTImageImpl.this.removeShadow(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfShadowArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTTextbox> getTextboxList()
    {
        final class TextboxList extends java.util.AbstractList<schemasMicrosoftComVml.CTTextbox>
        {
            public schemasMicrosoftComVml.CTTextbox get(int i)
                { return CTImageImpl.this.getTextboxArray(i); }
            
            public schemasMicrosoftComVml.CTTextbox set(int i, schemasMicrosoftComVml.CTTextbox o)
            {
                schemasMicrosoftComVml.CTTextbox old = CTImageImpl.this.getTextboxArray(i);
                CTImageImpl.this.setTextboxArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTTextbox o)
                { CTImageImpl.this.insertNewTextbox(i).set(o); }
            
            public schemasMicrosoftComVml.CTTextbox remove(int i)
            {
                schemasMicrosoftComVml.CTTextbox old = CTImageImpl.this.getTextboxArray(i);
                CTImageImpl.this.removeTextbox(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfTextboxArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTTextPath> getTextpathList()
    {
        final class TextpathList extends java.util.AbstractList<schemasMicrosoftComVml.CTTextPath>
        {
            public schemasMicrosoftComVml.CTTextPath get(int i)
                { return CTImageImpl.this.getTextpathArray(i); }
            
            public schemasMicrosoftComVml.CTTextPath set(int i, schemasMicrosoftComVml.CTTextPath o)
            {
                schemasMicrosoftComVml.CTTextPath old = CTImageImpl.this.getTextpathArray(i);
                CTImageImpl.this.setTextpathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTTextPath o)
                { CTImageImpl.this.insertNewTextpath(i).set(o); }
            
            public schemasMicrosoftComVml.CTTextPath remove(int i)
            {
                schemasMicrosoftComVml.CTTextPath old = CTImageImpl.this.getTextpathArray(i);
                CTImageImpl.this.removeTextpath(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfTextpathArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTImageData> getImagedataList()
    {
        final class ImagedataList extends java.util.AbstractList<schemasMicrosoftComVml.CTImageData>
        {
            public schemasMicrosoftComVml.CTImageData get(int i)
                { return CTImageImpl.this.getImagedataArray(i); }
            
            public schemasMicrosoftComVml.CTImageData set(int i, schemasMicrosoftComVml.CTImageData o)
            {
                schemasMicrosoftComVml.CTImageData old = CTImageImpl.this.getImagedataArray(i);
                CTImageImpl.this.setImagedataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTImageData o)
                { CTImageImpl.this.insertNewImagedata(i).set(o); }
            
            public schemasMicrosoftComVml.CTImageData remove(int i)
            {
                schemasMicrosoftComVml.CTImageData old = CTImageImpl.this.getImagedataArray(i);
                CTImageImpl.this.removeImagedata(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfImagedataArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTSkew> getSkewList()
    {
        final class SkewList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTSkew>
        {
            public schemasMicrosoftComOfficeOffice.CTSkew get(int i)
                { return CTImageImpl.this.getSkewArray(i); }
            
            public schemasMicrosoftComOfficeOffice.CTSkew set(int i, schemasMicrosoftComOfficeOffice.CTSkew o)
            {
                schemasMicrosoftComOfficeOffice.CTSkew old = CTImageImpl.this.getSkewArray(i);
                CTImageImpl.this.setSkewArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTSkew o)
                { CTImageImpl.this.insertNewSkew(i).set(o); }
            
            public schemasMicrosoftComOfficeOffice.CTSkew remove(int i)
            {
                schemasMicrosoftComOfficeOffice.CTSkew old = CTImageImpl.this.getSkewArray(i);
                CTImageImpl.this.removeSkew(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfSkewArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTExtrusion> getExtrusionList()
    {
        final class ExtrusionList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTExtrusion>
        {
            public schemasMicrosoftComOfficeOffice.CTExtrusion get(int i)
                { return CTImageImpl.this.getExtrusionArray(i); }
            
            public schemasMicrosoftComOfficeOffice.CTExtrusion set(int i, schemasMicrosoftComOfficeOffice.CTExtrusion o)
            {
                schemasMicrosoftComOfficeOffice.CTExtrusion old = CTImageImpl.this.getExtrusionArray(i);
                CTImageImpl.this.setExtrusionArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTExtrusion o)
                { CTImageImpl.this.insertNewExtrusion(i).set(o); }
            
            public schemasMicrosoftComOfficeOffice.CTExtrusion remove(int i)
            {
                schemasMicrosoftComOfficeOffice.CTExtrusion old = CTImageImpl.this.getExtrusionArray(i);
                CTImageImpl.this.removeExtrusion(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfExtrusionArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTCallout> getCalloutList()
    {
        final class CalloutList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTCallout>
        {
            public schemasMicrosoftComOfficeOffice.CTCallout get(int i)
                { return CTImageImpl.this.getCalloutArray(i); }
            
            public schemasMicrosoftComOfficeOffice.CTCallout set(int i, schemasMicrosoftComOfficeOffice.CTCallout o)
            {
                schemasMicrosoftComOfficeOffice.CTCallout old = CTImageImpl.this.getCalloutArray(i);
                CTImageImpl.this.setCalloutArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTCallout o)
                { CTImageImpl.this.insertNewCallout(i).set(o); }
            
            public schemasMicrosoftComOfficeOffice.CTCallout remove(int i)
            {
                schemasMicrosoftComOfficeOffice.CTCallout old = CTImageImpl.this.getCalloutArray(i);
                CTImageImpl.this.removeCallout(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfCalloutArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTLock> getLockList()
    {
        final class LockList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTLock>
        {
            public schemasMicrosoftComOfficeOffice.CTLock get(int i)
                { return CTImageImpl.this.getLockArray(i); }
            
            public schemasMicrosoftComOfficeOffice.CTLock set(int i, schemasMicrosoftComOfficeOffice.CTLock o)
            {
                schemasMicrosoftComOfficeOffice.CTLock old = CTImageImpl.this.getLockArray(i);
                CTImageImpl.this.setLockArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTLock o)
                { CTImageImpl.this.insertNewLock(i).set(o); }
            
            public schemasMicrosoftComOfficeOffice.CTLock remove(int i)
            {
                schemasMicrosoftComOfficeOffice.CTLock old = CTImageImpl.this.getLockArray(i);
                CTImageImpl.this.removeLock(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfLockArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTClipPath> getClippathList()
    {
        final class ClippathList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTClipPath>
        {
            public schemasMicrosoftComOfficeOffice.CTClipPath get(int i)
                { return CTImageImpl.this.getClippathArray(i); }
            
            public schemasMicrosoftComOfficeOffice.CTClipPath set(int i, schemasMicrosoftComOfficeOffice.CTClipPath o)
            {
                schemasMicrosoftComOfficeOffice.CTClipPath old = CTImageImpl.this.getClippathArray(i);
                CTImageImpl.this.setClippathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTClipPath o)
                { CTImageImpl.this.insertNewClippath(i).set(o); }
            
            public schemasMicrosoftComOfficeOffice.CTClipPath remove(int i)
            {
                schemasMicrosoftComOfficeOffice.CTClipPath old = CTImageImpl.this.getClippathArray(i);
                CTImageImpl.this.removeClippath(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfClippathArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTSignatureLine> getSignaturelineList()
    {
        final class SignaturelineList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTSignatureLine>
        {
            public schemasMicrosoftComOfficeOffice.CTSignatureLine get(int i)
                { return CTImageImpl.this.getSignaturelineArray(i); }
            
            public schemasMicrosoftComOfficeOffice.CTSignatureLine set(int i, schemasMicrosoftComOfficeOffice.CTSignatureLine o)
            {
                schemasMicrosoftComOfficeOffice.CTSignatureLine old = CTImageImpl.this.getSignaturelineArray(i);
                CTImageImpl.this.setSignaturelineArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTSignatureLine o)
                { CTImageImpl.this.insertNewSignatureline(i).set(o); }
            
            public schemasMicrosoftComOfficeOffice.CTSignatureLine remove(int i)
            {
                schemasMicrosoftComOfficeOffice.CTSignatureLine old = CTImageImpl.this.getSignaturelineArray(i);
                CTImageImpl.this.removeSignatureline(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfSignaturelineArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTWrap> getWrapList()
    {
        final class WrapList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTWrap>
        {
            public schemasMicrosoftComOfficeWord.CTWrap get(int i)
                { return CTImageImpl.this.getWrapArray(i); }
            
            public schemasMicrosoftComOfficeWord.CTWrap set(int i, schemasMicrosoftComOfficeWord.CTWrap o)
            {
                schemasMicrosoftComOfficeWord.CTWrap old = CTImageImpl.this.getWrapArray(i);
                CTImageImpl.this.setWrapArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTWrap o)
                { CTImageImpl.this.insertNewWrap(i).set(o); }
            
            public schemasMicrosoftComOfficeWord.CTWrap remove(int i)
            {
                schemasMicrosoftComOfficeWord.CTWrap old = CTImageImpl.this.getWrapArray(i);
                CTImageImpl.this.removeWrap(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfWrapArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTAnchorLock> getAnchorlockList()
    {
        final class AnchorlockList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTAnchorLock>
        {
            public schemasMicrosoftComOfficeWord.CTAnchorLock get(int i)
                { return CTImageImpl.this.getAnchorlockArray(i); }
            
            public schemasMicrosoftComOfficeWord.CTAnchorLock set(int i, schemasMicrosoftComOfficeWord.CTAnchorLock o)
            {
                schemasMicrosoftComOfficeWord.CTAnchorLock old = CTImageImpl.this.getAnchorlockArray(i);
                CTImageImpl.this.setAnchorlockArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTAnchorLock o)
                { CTImageImpl.this.insertNewAnchorlock(i).set(o); }
            
            public schemasMicrosoftComOfficeWord.CTAnchorLock remove(int i)
            {
                schemasMicrosoftComOfficeWord.CTAnchorLock old = CTImageImpl.this.getAnchorlockArray(i);
                CTImageImpl.this.removeAnchorlock(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfAnchorlockArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBordertopList()
    {
        final class BordertopList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTBorder>
        {
            public schemasMicrosoftComOfficeWord.CTBorder get(int i)
                { return CTImageImpl.this.getBordertopArray(i); }
            
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTImageImpl.this.getBordertopArray(i);
                CTImageImpl.this.setBordertopArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTImageImpl.this.insertNewBordertop(i).set(o); }
            
            public schemasMicrosoftComOfficeWord.CTBorder remove(int i)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTImageImpl.this.getBordertopArray(i);
                CTImageImpl.this.removeBordertop(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfBordertopArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderbottomList()
    {
        ...
        {
            public schemasMicrosoftComOfficeWord.CTBorder get(int i)
                { return CTImageImpl.this.getBorderbottomArray(i); }
            
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTImageImpl.this.getBorderbottomArray(i);
                CTImageImpl.this.setBorderbottomArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTImageImpl.this.insertNewBorderbottom(i).set(o); }
            
            public schemasMicrosoftComOfficeWord.CTBorder remove(int i)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTImageImpl.this.getBorderbottomArray(i);
                CTImageImpl.this.removeBorderbottom(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfBorderbottomArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderleftList()
    {
        ...
        {
            public schemasMicrosoftComOfficeWord.CTBorder get(int i)
                { return CTImageImpl.this.getBorderleftArray(i); }
            
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTImageImpl.this.getBorderleftArray(i);
                CTImageImpl.this.setBorderleftArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTImageImpl.this.insertNewBorderleft(i).set(o); }
            
            public schemasMicrosoftComOfficeWord.CTBorder remove(int i)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTImageImpl.this.getBorderleftArray(i);
                CTImageImpl.this.removeBorderleft(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfBorderleftArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderrightList()
    {
        ...
        {
            public schemasMicrosoftComOfficeWord.CTBorder get(int i)
                { return CTImageImpl.this.getBorderrightArray(i); }
            
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTImageImpl.this.getBorderrightArray(i);
                CTImageImpl.this.setBorderrightArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTImageImpl.this.insertNewBorderright(i).set(o); }
            
            public schemasMicrosoftComOfficeWord.CTBorder remove(int i)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTImageImpl.this.getBorderrightArray(i);
                CTImageImpl.this.removeBorderright(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfBorderrightArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeExcel.CTClientData> getClientDataList()
    {
        final class ClientDataList extends java.util.AbstractList<schemasMicrosoftComOfficeExcel.CTClientData>
        {
            public schemasMicrosoftComOfficeExcel.CTClientData get(int i)
                { return CTImageImpl.this.getClientDataArray(i); }
            
            public schemasMicrosoftComOfficeExcel.CTClientData set(int i, schemasMicrosoftComOfficeExcel.CTClientData o)
            {
                schemasMicrosoftComOfficeExcel.CTClientData old = CTImageImpl.this.getClientDataArray(i);
                CTImageImpl.this.setClientDataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeExcel.CTClientData o)
                { CTImageImpl.this.insertNewClientData(i).set(o); }
            
            public schemasMicrosoftComOfficeExcel.CTClientData remove(int i)
            {
                schemasMicrosoftComOfficeExcel.CTClientData old = CTImageImpl.this.getClientDataArray(i);
                CTImageImpl.this.removeClientData(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfClientDataArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficePowerpoint.CTRel> getTextdataList()
    {
        final class TextdataList extends java.util.AbstractList<schemasMicrosoftComOfficePowerpoint.CTRel>
        {
            public schemasMicrosoftComOfficePowerpoint.CTRel get(int i)
                { return CTImageImpl.this.getTextdataArray(i); }
            
            public schemasMicrosoftComOfficePowerpoint.CTRel set(int i, schemasMicrosoftComOfficePowerpoint.CTRel o)
            {
                schemasMicrosoftComOfficePowerpoint.CTRel old = CTImageImpl.this.getTextdataArray(i);
                CTImageImpl.this.setTextdataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficePowerpoint.CTRel o)
                { CTImageImpl.this.insertNewTextdata(i).set(o); }
            
            public schemasMicrosoftComOfficePowerpoint.CTRel remove(int i)
            {
                schemasMicrosoftComOfficePowerpoint.CTRel old = CTImageImpl.this.getTextdataArray(i);
                CTImageImpl.this.removeTextdata(i);
                return old;
            }
            
            public int size()
                { return CTImageImpl.this.sizeOfTextdataArray(); }
    ...
    public java.lang.String getSrc()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(SRC$152);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetSrc()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(SRC$152);
            return target;
        }
    }
    ...
    public boolean isSetSrc()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(SRC$152) != null;
        }
    }
    ...
    public void setSrc(java.lang.String src)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(SRC$152);
            }
    ...
    public void xsetSrc(org.apache.xmlbeans.XmlString src)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(SRC$152);
            }
            target.set(src);
        }
    }
    ...
    public void unsetSrc()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(SRC$152);
        }
    }
    ...
    public java.lang.String getCropleft()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(CROPLEFT$154);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetCropleft()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(CROPLEFT$154);
            return target;
        }
    }
    ...
    public boolean isSetCropleft()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(CROPLEFT$154) != null;
        }
    }
    ...
    public void setCropleft(java.lang.String cropleft)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(CROPLEFT$154);
            }
    ...
    public void xsetCropleft(org.apache.xmlbeans.XmlString cropleft)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(CROPLEFT$154);
            }
            target.set(cropleft);
        }
    }
    ...
    public void unsetCropleft()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(CROPLEFT$154);
        }
    }
    ...
    public java.lang.String getCroptop()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(CROPTOP$156);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetCroptop()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(CROPTOP$156);
            return target;
        }
    }
    ...
    public boolean isSetCroptop()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(CROPTOP$156) != null;
        }
    }
    ...
    public void setCroptop(java.lang.String croptop)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(CROPTOP$156);
            }
    ...
    public void xsetCroptop(org.apache.xmlbeans.XmlString croptop)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(CROPTOP$156);
            }
            target.set(croptop);
        }
    }
    ...
    public void unsetCroptop()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(CROPTOP$156);
        }
    }
    ...
    public java.lang.String getCropright()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(CROPRIGHT$158);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetCropright()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(CROPRIGHT$158);
            return target;
        }
    }
    ...
    public boolean isSetCropright()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(CROPRIGHT$158) != null;
        }
    }
    ...
    public void setCropright(java.lang.String cropright)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(CROPRIGHT$158);
            }
    ...
    public void xsetCropright(org.apache.xmlbeans.XmlString cropright)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(CROPRIGHT$158);
            }
    ...
    public void unsetCropright()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(CROPRIGHT$158);
        }
    }
    ...
    public java.lang.String getCropbottom()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(CROPBOTTOM$160);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetCropbottom()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(CROPBOTTOM$160);
            return target;
        }
    }
    ...
    public boolean isSetCropbottom()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(CROPBOTTOM$160) != null;
        }
    }
    ...
    public void setCropbottom(java.lang.String cropbottom)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(CROPBOTTOM$160);
            }
    ...
    public void xsetCropbottom(org.apache.xmlbeans.XmlString cropbottom)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(CROPBOTTOM$160);
            }
    ...
    public void unsetCropbottom()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(CROPBOTTOM$160);
        }
    }
    ...
    public java.lang.String getGain()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(GAIN$162);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetGain()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(GAIN$162);
            return target;
        }
    }
    ...
    public boolean isSetGain()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(GAIN$162) != null;
        }
    }
    ...
    public void setGain(java.lang.String gain)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(GAIN$162);
            }
    ...
    public void xsetGain(org.apache.xmlbeans.XmlString gain)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(GAIN$162);
            }
            target.set(gain);
        }
    }
    ...
    public void unsetGain()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(GAIN$162);
        }
    }
    ...
    public java.lang.String getBlacklevel()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(BLACKLEVEL$164);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetBlacklevel()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(BLACKLEVEL$164);
            return target;
        }
    }
    ...
    public boolean isSetBlacklevel()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(BLACKLEVEL$164) != null;
        }
    }
    ...
    public void setBlacklevel(java.lang.String blacklevel)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(BLACKLEVEL$164);
            }
    ...
    public void xsetBlacklevel(org.apache.xmlbeans.XmlString blacklevel)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(BLACKLEVEL$164);
            }
    ...
    public void unsetBlacklevel()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(BLACKLEVEL$164);
        }
    }
    ...
    public java.lang.String getGamma()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(GAMMA$166);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetGamma()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(GAMMA$166);
            return target;
        }
    }
    ...
    public boolean isSetGamma()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(GAMMA$166) != null;
        }
    }
    ...
    public void setGamma(java.lang.String gamma)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(GAMMA$166);
            }
    ...
    public void xsetGamma(org.apache.xmlbeans.XmlString gamma)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(GAMMA$166);
            }
            target.set(gamma);
        }
    }
    ...
    public void unsetGamma()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(GAMMA$166);
        }
    }
     ...
     */
    public schemasMicrosoftComVml.STTrueFalse.Enum getGrayscale()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(GRAYSCALE$168);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public schemasMicrosoftComVml.STTrueFalse xgetGrayscale()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STTrueFalse target = null;
            target = (schemasMicrosoftComVml.STTrueFalse)get_store().find_attribute_user(GRAYSCALE$168);
            return target;
        }
    }
    ...
    public boolean isSetGrayscale()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(GRAYSCALE$168) != null;
        }
    }
     ...
     */
    public void setGrayscale(schemasMicrosoftComVml.STTrueFalse.Enum grayscale)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(GRAYSCALE$168);
            }
     ...
     */
    public void xsetGrayscale(schemasMicrosoftComVml.STTrueFalse grayscale)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STTrueFalse)get_store().add_attribute_user(GRAYSCALE$168);
            }
    ...
    public void unsetGrayscale()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(GRAYSCALE$168);
        }
    }
     ...
     */
    public schemasMicrosoftComVml.STTrueFalse.Enum getBilevel()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(BILEVEL$170);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public schemasMicrosoftComVml.STTrueFalse xgetBilevel()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STTrueFalse target = null;
            target = (schemasMicrosoftComVml.STTrueFalse)get_store().find_attribute_user(BILEVEL$170);
            return target;
        }
    }
    ...
    public boolean isSetBilevel()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(BILEVEL$170) != null;
        }
    }
     ...
     */
    public void setBilevel(schemasMicrosoftComVml.STTrueFalse.Enum bilevel)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(BILEVEL$170);
            }
     ...
     */
    public void xsetBilevel(schemasMicrosoftComVml.STTrueFalse bilevel)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STTrueFalse)get_store().add_attribute_user(BILEVEL$170);
            }
            target.set(bilevel);
        }
    }
    ...
    public void unsetBilevel()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(BILEVEL$170);
        }
    }
}
