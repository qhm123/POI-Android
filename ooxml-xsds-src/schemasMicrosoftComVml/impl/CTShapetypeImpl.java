/*
 * XML Type:  CT_Shapetype
 * Namespace: urn:schemas-microsoft-com:vml
 * Java type: schemasMicrosoftComVml.CTShapetype
 *
 * Automatically generated - do not modify.
 */
package schemasMicrosoftComVml.impl;
/**
 * An XML CT_Shapetype(@urn:schemas-microsoft-com:vml).
 *
 * This is a complex type.
 */
public class CTShapetypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements schemasMicrosoftComVml.CTShapetype
{
    
    public CTShapetypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName COMPLEX$46 = 
    ...
    private static final javax.xml.namespace.QName ADJ$154 = 
        new javax.xml.namespace.QName("", "adj");
    private static final javax.xml.namespace.QName PATH2$156 = 
        new javax.xml.namespace.QName("", "path");
    private static final javax.xml.namespace.QName MASTER$158 = 
    ...
    public java.util.List<schemasMicrosoftComVml.CTPath> getPathList()
    {
        final class PathList extends java.util.AbstractList<schemasMicrosoftComVml.CTPath>
        {
            ...
            {
                schemasMicrosoftComVml.CTPath old = CTShapetypeImpl.this.getPathArray(i);
                CTShapetypeImpl.this.setPathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTPath o)
                { CTShapetypeImpl.this.insertNewPath(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTFormulas> getFormulasList()
    {
        final class FormulasList extends java.util.AbstractList<schemasMicrosoftComVml.CTFormulas>
        {
            ...
            {
                schemasMicrosoftComVml.CTFormulas old = CTShapetypeImpl.this.getFormulasArray(i);
                CTShapetypeImpl.this.setFormulasArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTFormulas o)
                { CTShapetypeImpl.this.insertNewFormulas(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTHandles> getHandlesList()
    {
        final class HandlesList extends java.util.AbstractList<schemasMicrosoftComVml.CTHandles>
        {
            ...
            {
                schemasMicrosoftComVml.CTHandles old = CTShapetypeImpl.this.getHandlesArray(i);
                CTShapetypeImpl.this.setHandlesArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTHandles o)
                { CTShapetypeImpl.this.insertNewHandles(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTFill> getFillList()
    {
        final class FillList extends java.util.AbstractList<schemasMicrosoftComVml.CTFill>
        {
            ...
            {
                schemasMicrosoftComVml.CTFill old = CTShapetypeImpl.this.getFillArray(i);
                CTShapetypeImpl.this.setFillArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTFill o)
                { CTShapetypeImpl.this.insertNewFill(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTStroke> getStrokeList()
    {
        final class StrokeList extends java.util.AbstractList<schemasMicrosoftComVml.CTStroke>
        {
            ...
            {
                schemasMicrosoftComVml.CTStroke old = CTShapetypeImpl.this.getStrokeArray(i);
                CTShapetypeImpl.this.setStrokeArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTStroke o)
                { CTShapetypeImpl.this.insertNewStroke(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTShadow> getShadowList()
    {
        final class ShadowList extends java.util.AbstractList<schemasMicrosoftComVml.CTShadow>
        {
            ...
            {
                schemasMicrosoftComVml.CTShadow old = CTShapetypeImpl.this.getShadowArray(i);
                CTShapetypeImpl.this.setShadowArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTShadow o)
                { CTShapetypeImpl.this.insertNewShadow(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTTextbox> getTextboxList()
    {
        final class TextboxList extends java.util.AbstractList<schemasMicrosoftComVml.CTTextbox>
        {
            ...
            {
                schemasMicrosoftComVml.CTTextbox old = CTShapetypeImpl.this.getTextboxArray(i);
                CTShapetypeImpl.this.setTextboxArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTTextbox o)
                { CTShapetypeImpl.this.insertNewTextbox(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTTextPath> getTextpathList()
    {
        final class TextpathList extends java.util.AbstractList<schemasMicrosoftComVml.CTTextPath>
        {
            ...
            {
                schemasMicrosoftComVml.CTTextPath old = CTShapetypeImpl.this.getTextpathArray(i);
                CTShapetypeImpl.this.setTextpathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTTextPath o)
                { CTShapetypeImpl.this.insertNewTextpath(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTImageData> getImagedataList()
    {
        final class ImagedataList extends java.util.AbstractList<schemasMicrosoftComVml.CTImageData>
        {
            ...
            {
                schemasMicrosoftComVml.CTImageData old = CTShapetypeImpl.this.getImagedataArray(i);
                CTShapetypeImpl.this.setImagedataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTImageData o)
                { CTShapetypeImpl.this.insertNewImagedata(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTSkew> getSkewList()
    {
        final class SkewList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTSkew>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTSkew old = CTShapetypeImpl.this.getSkewArray(i);
                CTShapetypeImpl.this.setSkewArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTSkew o)
                { CTShapetypeImpl.this.insertNewSkew(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTExtrusion> getExtrusionList()
    {
        final class ExtrusionList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTExtrusion>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTExtrusion old = CTShapetypeImpl.this.getExtrusionArray(i);
                CTShapetypeImpl.this.setExtrusionArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTExtrusion o)
                { CTShapetypeImpl.this.insertNewExtrusion(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTCallout> getCalloutList()
    {
        final class CalloutList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTCallout>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTCallout old = CTShapetypeImpl.this.getCalloutArray(i);
                CTShapetypeImpl.this.setCalloutArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTCallout o)
                { CTShapetypeImpl.this.insertNewCallout(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTLock> getLockList()
    {
        final class LockList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTLock>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTLock old = CTShapetypeImpl.this.getLockArray(i);
                CTShapetypeImpl.this.setLockArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTLock o)
                { CTShapetypeImpl.this.insertNewLock(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTClipPath> getClippathList()
    {
        final class ClippathList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTClipPath>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTClipPath old = CTShapetypeImpl.this.getClippathArray(i);
                CTShapetypeImpl.this.setClippathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTClipPath o)
                { CTShapetypeImpl.this.insertNewClippath(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTSignatureLine> getSignaturelineList()
    {
        final class SignaturelineList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTSignatureLine>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTSignatureLine old = CTShapetypeImpl.this.getSignaturelineArray(i);
                CTShapetypeImpl.this.setSignaturelineArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTSignatureLine o)
                { CTShapetypeImpl.this.insertNewSignatureline(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTWrap> getWrapList()
    {
        final class WrapList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTWrap>
        {
            ...
            {
                schemasMicrosoftComOfficeWord.CTWrap old = CTShapetypeImpl.this.getWrapArray(i);
                CTShapetypeImpl.this.setWrapArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTWrap o)
                { CTShapetypeImpl.this.insertNewWrap(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTAnchorLock> getAnchorlockList()
    {
        final class AnchorlockList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTAnchorLock>
        {
            ...
            {
                schemasMicrosoftComOfficeWord.CTAnchorLock old = CTShapetypeImpl.this.getAnchorlockArray(i);
                CTShapetypeImpl.this.setAnchorlockArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTAnchorLock o)
                { CTShapetypeImpl.this.insertNewAnchorlock(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBordertopList()
    {
        final class BordertopList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTBorder>
        {
            ...
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTShapetypeImpl.this.getBordertopArray(i);
                CTShapetypeImpl.this.setBordertopArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTShapetypeImpl.this.insertNewBordertop(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderbottomList()
    {
        final class BorderbottomList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTBorder>
        {
            ...
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTShapetypeImpl.this.getBorderbottomArray(i);
                CTShapetypeImpl.this.setBorderbottomArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTShapetypeImpl.this.insertNewBorderbottom(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderleftList()
    {
        final class BorderleftList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTBorder>
        {
            ...
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTShapetypeImpl.this.getBorderleftArray(i);
                CTShapetypeImpl.this.setBorderleftArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTShapetypeImpl.this.insertNewBorderleft(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderrightList()
    {
        final class BorderrightList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTBorder>
        {
            ...
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTShapetypeImpl.this.getBorderrightArray(i);
                CTShapetypeImpl.this.setBorderrightArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTShapetypeImpl.this.insertNewBorderright(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeExcel.CTClientData> getClientDataList()
    {
        final class ClientDataList extends java.util.AbstractList<schemasMicrosoftComOfficeExcel.CTClientData>
        {
            ...
            {
                schemasMicrosoftComOfficeExcel.CTClientData old = CTShapetypeImpl.this.getClientDataArray(i);
                CTShapetypeImpl.this.setClientDataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeExcel.CTClientData o)
                { CTShapetypeImpl.this.insertNewClientData(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficePowerpoint.CTRel> getTextdataList()
    {
        final class TextdataList extends java.util.AbstractList<schemasMicrosoftComOfficePowerpoint.CTRel>
        {
            ...
            {
                schemasMicrosoftComOfficePowerpoint.CTRel old = CTShapetypeImpl.this.getTextdataArray(i);
                CTShapetypeImpl.this.setTextdataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficePowerpoint.CTRel o)
                { CTShapetypeImpl.this.insertNewTextdata(i).set(o); }
    ...
    public schemasMicrosoftComOfficeOffice.CTComplex getComplex()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.CTComplex)get_store().find_element_user(COMPLEX$46, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setComplex(schemasMicrosoftComOfficeOffice.CTComplex complex)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.CTComplex)get_store().add_element_user(COMPLEX$46);
            }
            target.set(complex);
        }
    }
    ...
    public schemasMicrosoftComVml.STTrueFalse xgetPrint()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComVml.STTrueFalse)get_store().find_attribute_user(PRINT$68);
            return target;
        }
    }
    ...
    public void xsetPrint(schemasMicrosoftComVml.STTrueFalse print)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STTrueFalse)get_store().add_attribute_user(PRINT$68);
            }
            target.set(print);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetOned()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(ONED$72);
            return target;
        }
    }
    ...
    public void xsetOned(schemasMicrosoftComOfficeOffice.STTrueFalse oned)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(ONED$72);
            }
            target.set(oned);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetDoubleclicknotify()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(DOUBLECLICKNOTIFY$76);
            return target;
        }
    }
    ...
    public void xsetDoubleclicknotify(schemasMicrosoftComOfficeOffice.STTrueFalse doubleclicknotify)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(DOUBLECLICKNOTIFY$76);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetButton()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(BUTTON$78);
            return target;
        }
    }
    ...
    public void xsetButton(schemasMicrosoftComOfficeOffice.STTrueFalse button)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(BUTTON$78);
            }
            target.set(button);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetUserhidden()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(USERHIDDEN$80);
            return target;
        }
    }
    ...
    public void xsetUserhidden(schemasMicrosoftComOfficeOffice.STTrueFalse userhidden)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(USERHIDDEN$80);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetBullet()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(BULLET$82);
            return target;
        }
    }
    ...
    public void xsetBullet(schemasMicrosoftComOfficeOffice.STTrueFalse bullet)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(BULLET$82);
            }
            target.set(bullet);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetHr()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(HR$84);
            return target;
        }
    }
    ...
    public void xsetHr(schemasMicrosoftComOfficeOffice.STTrueFalse hr)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(HR$84);
            }
            target.set(hr);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetHrstd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(HRSTD$86);
            return target;
        }
    }
    ...
    public void xsetHrstd(schemasMicrosoftComOfficeOffice.STTrueFalse hrstd)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(HRSTD$86);
            }
            target.set(hrstd);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetHrnoshade()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(HRNOSHADE$88);
            return target;
        }
    }
    ...
    public void xsetHrnoshade(schemasMicrosoftComOfficeOffice.STTrueFalse hrnoshade)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(HRNOSHADE$88);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STHrAlign xgetHralign()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.STHrAlign)get_store().find_attribute_user(HRALIGN$92);
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STHrAlign)get_default_attribute_value(HRALIGN$92);
            }
            return target;
        }
    }
    ...
    public void xsetHralign(schemasMicrosoftComOfficeOffice.STHrAlign hralign)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STHrAlign)get_store().add_attribute_user(HRALIGN$92);
            }
            target.set(hralign);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetAllowincell()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(ALLOWINCELL$94);
            return target;
        }
    }
    ...
    public void xsetAllowincell(schemasMicrosoftComOfficeOffice.STTrueFalse allowincell)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(ALLOWINCELL$94);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetAllowoverlap()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(ALLOWOVERLAP$96);
            return target;
        }
    }
    ...
    public void xsetAllowoverlap(schemasMicrosoftComOfficeOffice.STTrueFalse allowoverlap)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(ALLOWOVERLAP$96);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetUserdrawn()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(USERDRAWN$98);
            return target;
        }
    }
    ...
    public void xsetUserdrawn(schemasMicrosoftComOfficeOffice.STTrueFalse userdrawn)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(USERDRAWN$98);
            }
    ...
    public org.apache.xmlbeans.XmlInteger xgetDgmlayout()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlInteger target = null;
            target = (org.apache.xmlbeans.XmlInteger)get_store().find_attribute_user(DGMLAYOUT$108);
            return target;
        }
    }
    ...
    public void xsetDgmlayout(org.apache.xmlbeans.XmlInteger dgmlayout)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlInteger)get_store().add_attribute_user(DGMLAYOUT$108);
            }
    ...
    public org.apache.xmlbeans.XmlInteger xgetDgmlayoutmru()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlInteger target = null;
            target = (org.apache.xmlbeans.XmlInteger)get_store().find_attribute_user(DGMLAYOUTMRU$112);
            return target;
        }
    }
    ...
    public void xsetDgmlayoutmru(org.apache.xmlbeans.XmlInteger dgmlayoutmru)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlInteger)get_store().add_attribute_user(DGMLAYOUTMRU$112);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STInsetMode xgetInsetmode()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.STInsetMode)get_store().find_attribute_user(INSETMODE$114);
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STInsetMode)get_default_attribute_value(INSETMODE$114);
            }
            return target;
        }
    }
    ...
    public void xsetInsetmode(schemasMicrosoftComOfficeOffice.STInsetMode insetmode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STInsetMode)get_store().add_attribute_user(INSETMODE$114);
            }
    ...
    public schemasMicrosoftComVml.STColorType xgetChromakey()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComVml.STColorType)get_store().find_attribute_user(CHROMAKEY$116);
            return target;
        }
    }
    ...
    public void xsetChromakey(schemasMicrosoftComVml.STColorType chromakey)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STColorType)get_store().add_attribute_user(CHROMAKEY$116);
            }
    ...
    public schemasMicrosoftComVml.STTrueFalse xgetFilled()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STTrueFalse target = null;
            target = (schemasMicrosoftComVml.STTrueFalse)get_store().find_attribute_user(FILLED$118);
            return target;
        }
    }
    ...
    public void xsetFilled(schemasMicrosoftComVml.STTrueFalse filled)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STTrueFalse)get_store().add_attribute_user(FILLED$118);
            }
            target.set(filled);
        }
    }
    ...
    public schemasMicrosoftComVml.STColorType xgetFillcolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STColorType target = null;
            target = (schemasMicrosoftComVml.STColorType)get_store().find_attribute_user(FILLCOLOR$120);
            return target;
        }
    }
    ...
    public void xsetFillcolor(schemasMicrosoftComVml.STColorType fillcolor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STColorType)get_store().add_attribute_user(FILLCOLOR$120);
            }
    ...
    public schemasMicrosoftComVml.STTrueFalse xgetStroked()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STTrueFalse target = null;
            target = (schemasMicrosoftComVml.STTrueFalse)get_store().find_attribute_user(STROKED$124);
            return target;
        }
    }
    ...
    public void xsetStroked(schemasMicrosoftComVml.STTrueFalse stroked)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STTrueFalse)get_store().add_attribute_user(STROKED$124);
            }
            target.set(stroked);
        }
    }
    ...
    public schemasMicrosoftComVml.STColorType xgetStrokecolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STColorType target = null;
            target = (schemasMicrosoftComVml.STColorType)get_store().find_attribute_user(STROKECOLOR$126);
            return target;
        }
    }
    ...
    public void xsetStrokecolor(schemasMicrosoftComVml.STColorType strokecolor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STColorType)get_store().add_attribute_user(STROKECOLOR$126);
            }
    ...
    public schemasMicrosoftComVml.STTrueFalse xgetInsetpen()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STTrueFalse target = null;
            target = (schemasMicrosoftComVml.STTrueFalse)get_store().find_attribute_user(INSETPEN$130);
            return target;
        }
    }
    ...
    public void xsetInsetpen(schemasMicrosoftComVml.STTrueFalse insetpen)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STTrueFalse)get_store().add_attribute_user(INSETPEN$130);
            }
            target.set(insetpen);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STConnectorType xgetConnectortype()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.STConnectorType)get_store().find_attribute_user(CONNECTORTYPE$134);
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STConnectorType)get_default_attribute_value(CONNECTORTYPE$134);
            }
            return target;
        }
    }
    ...
    public void xsetConnectortype(schemasMicrosoftComOfficeOffice.STConnectorType connectortype)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STConnectorType)get_store().add_attribute_user(CONNECTORTYPE$134);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STBWMode xgetBwmode()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.STBWMode)get_store().find_attribute_user(BWMODE$136);
            return target;
        }
    }
    ...
    public void xsetBwmode(schemasMicrosoftComOfficeOffice.STBWMode bwmode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STBWMode)get_store().add_attribute_user(BWMODE$136);
            }
            target.set(bwmode);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STBWMode xgetBwpure()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STBWMode target = null;
            target = (schemasMicrosoftComOfficeOffice.STBWMode)get_store().find_attribute_user(BWPURE$138);
            return target;
        }
    }
    ...
    public void xsetBwpure(schemasMicrosoftComOfficeOffice.STBWMode bwpure)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STBWMode)get_store().add_attribute_user(BWPURE$138);
            }
            target.set(bwpure);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STBWMode xgetBwnormal()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STBWMode target = null;
            target = (schemasMicrosoftComOfficeOffice.STBWMode)get_store().find_attribute_user(BWNORMAL$140);
            return target;
        }
    }
    ...
    public void xsetBwnormal(schemasMicrosoftComOfficeOffice.STBWMode bwnormal)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STBWMode)get_store().add_attribute_user(BWNORMAL$140);
            }
            target.set(bwnormal);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetForcedash()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(FORCEDASH$142);
            return target;
        }
    }
    ...
    public void xsetForcedash(schemasMicrosoftComOfficeOffice.STTrueFalse forcedash)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(FORCEDASH$142);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetOleicon()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(OLEICON$144);
            return target;
        }
    }
    ...
    public void xsetOleicon(schemasMicrosoftComOfficeOffice.STTrueFalse oleicon)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(OLEICON$144);
            }
            target.set(oleicon);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalseBlank xgetOle()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.STTrueFalseBlank)get_store().find_attribute_user(OLE$146);
            return target;
        }
    }
    ...
    public void xsetOle(schemasMicrosoftComOfficeOffice.STTrueFalseBlank ole)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalseBlank)get_store().add_attribute_user(OLE$146);
            }
            target.set(ole);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetPreferrelative()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(PREFERRELATIVE$148);
            return target;
        }
    }
    ...
    public void xsetPreferrelative(schemasMicrosoftComOfficeOffice.STTrueFalse preferrelative)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(PREFERRELATIVE$148);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetCliptowrap()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(CLIPTOWRAP$150);
            return target;
        }
    }
    ...
    public void xsetCliptowrap(schemasMicrosoftComOfficeOffice.STTrueFalse cliptowrap)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(CLIPTOWRAP$150);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetClip()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(CLIP$152);
            return target;
        }
    }
    ...
    public void xsetClip(schemasMicrosoftComOfficeOffice.STTrueFalse clip)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(CLIP$152);
            }
            target.set(clip);
        }
    }
    ...
    public java.lang.String getAdj()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ADJ$154);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetAdj()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(ADJ$154);
            return target;
        }
    }
    ...
    public void setAdj(java.lang.String adj)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ADJ$154);
            }
    ...
    public void xsetAdj(org.apache.xmlbeans.XmlString adj)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(ADJ$154);
            }
            target.set(adj);
        }
    }
    ...
    public java.lang.String getPath2()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(PATH2$156);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetPath2()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(PATH2$156);
            return target;
        }
    }
    ...
    public void setPath2(java.lang.String path2)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(PATH2$156);
            }
    ...
    public void xsetPath2(org.apache.xmlbeans.XmlString path2)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(PATH2$156);
            }
            target.set(path2);
        }
    }
    ...
    public java.lang.String getMaster()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(MASTER$158);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetMaster()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(MASTER$158);
            return target;
        }
    }
    ...
    public void setMaster(java.lang.String master)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(MASTER$158);
            }
    ...
    public void xsetMaster(org.apache.xmlbeans.XmlString master)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(MASTER$158);
            }
            target.set(master);
        }
    }
