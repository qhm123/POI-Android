 ...
 */
public class CTImageDataImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements schemasMicrosoftComVml.CTImageData
{
    ...
    public schemasMicrosoftComVml.STTrueFalse xgetGrayscale()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComVml.STTrueFalse)get_store().find_attribute_user(GRAYSCALE$18);
            return target;
        }
    }
    ...
    public void xsetGrayscale(schemasMicrosoftComVml.STTrueFalse grayscale)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STTrueFalse)get_store().add_attribute_user(GRAYSCALE$18);
            }
    ...
    public schemasMicrosoftComVml.STTrueFalse xgetBilevel()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STTrueFalse target = null;
            target = (schemasMicrosoftComVml.STTrueFalse)get_store().find_attribute_user(BILEVEL$20);
            return target;
        }
    }
    ...
    public void xsetBilevel(schemasMicrosoftComVml.STTrueFalse bilevel)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STTrueFalse)get_store().add_attribute_user(BILEVEL$20);
            }
            target.set(bilevel);
        }
    }
    ...
    public schemasMicrosoftComVml.STColorType xgetChromakey()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComVml.STColorType)get_store().find_attribute_user(CHROMAKEY$22);
            return target;
        }
    }
    ...
    public void xsetChromakey(schemasMicrosoftComVml.STColorType chromakey)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STColorType)get_store().add_attribute_user(CHROMAKEY$22);
            }
     ...
     */
    public schemasMicrosoftComVml.STColorType xgetEmbosscolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STColorType target = null;
            target = (schemasMicrosoftComVml.STColorType)get_store().find_attribute_user(EMBOSSCOLOR$24);
            return target;
        }
    }
     ...
     */
    public void xsetEmbosscolor(schemasMicrosoftComVml.STColorType embosscolor)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STColorType)get_store().add_attribute_user(EMBOSSCOLOR$24);
            }
     ...
     */
    public schemasMicrosoftComVml.STColorType xgetRecolortarget()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STColorType target = null;
            target = (schemasMicrosoftComVml.STColorType)get_store().find_attribute_user(RECOLORTARGET$26);
            return target;
        }
    }
     ...
     */
    public void xsetRecolortarget(schemasMicrosoftComVml.STColorType recolortarget)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STColorType)get_store().add_attribute_user(RECOLORTARGET$26);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetDetectmouseclick()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(DETECTMOUSECLICK$36);
            return target;
        }
    }
    ...
    public void xsetDetectmouseclick(schemasMicrosoftComOfficeOffice.STTrueFalse detectmouseclick)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(DETECTMOUSECLICK$36);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STRelationshipId xgetRelid()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.STRelationshipId)get_store().find_attribute_user(RELID$40);
            return target;
        }
    }
    ...
    public void xsetRelid(schemasMicrosoftComOfficeOffice.STRelationshipId relid)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STRelationshipId)get_store().add_attribute_user(RELID$40);
            }
            target.set(relid);
        }
    }
