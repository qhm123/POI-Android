 ...
 */
public class CTShapeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements schemasMicrosoftComVml.CTShape
{
    ...
    private static final javax.xml.namespace.QName ISCOMMENT$48 = 
        new javax.xml.namespace.QName("urn:schemas-microsoft-com:office:powerpoint", "iscomment");
    private static final javax.xml.namespace.QName ID$50 = 
        new javax.xml.namespace.QName("", "id");
    private static final javax.xml.namespace.QName STYLE$52 = 
    ...
    public java.util.List<schemasMicrosoftComVml.CTPath> getPathList()
    {
        final class PathList extends java.util.AbstractList<schemasMicrosoftComVml.CTPath>
        {
            ...
            {
                schemasMicrosoftComVml.CTPath old = CTShapeImpl.this.getPathArray(i);
                CTShapeImpl.this.setPathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTPath o)
                { CTShapeImpl.this.insertNewPath(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTFormulas> getFormulasList()
    {
        final class FormulasList extends java.util.AbstractList<schemasMicrosoftComVml.CTFormulas>
        {
            ...
            {
                schemasMicrosoftComVml.CTFormulas old = CTShapeImpl.this.getFormulasArray(i);
                CTShapeImpl.this.setFormulasArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTFormulas o)
                { CTShapeImpl.this.insertNewFormulas(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTHandles> getHandlesList()
    {
        final class HandlesList extends java.util.AbstractList<schemasMicrosoftComVml.CTHandles>
        {
            ...
            {
                schemasMicrosoftComVml.CTHandles old = CTShapeImpl.this.getHandlesArray(i);
                CTShapeImpl.this.setHandlesArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTHandles o)
                { CTShapeImpl.this.insertNewHandles(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTFill> getFillList()
    {
        final class FillList extends java.util.AbstractList<schemasMicrosoftComVml.CTFill>
        {
            ...
            {
                schemasMicrosoftComVml.CTFill old = CTShapeImpl.this.getFillArray(i);
                CTShapeImpl.this.setFillArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTFill o)
                { CTShapeImpl.this.insertNewFill(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTStroke> getStrokeList()
    {
        final class StrokeList extends java.util.AbstractList<schemasMicrosoftComVml.CTStroke>
        {
            ...
            {
                schemasMicrosoftComVml.CTStroke old = CTShapeImpl.this.getStrokeArray(i);
                CTShapeImpl.this.setStrokeArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTStroke o)
                { CTShapeImpl.this.insertNewStroke(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTShadow> getShadowList()
    {
        final class ShadowList extends java.util.AbstractList<schemasMicrosoftComVml.CTShadow>
        {
            ...
            {
                schemasMicrosoftComVml.CTShadow old = CTShapeImpl.this.getShadowArray(i);
                CTShapeImpl.this.setShadowArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTShadow o)
                { CTShapeImpl.this.insertNewShadow(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTTextbox> getTextboxList()
    {
        final class TextboxList extends java.util.AbstractList<schemasMicrosoftComVml.CTTextbox>
        {
            ...
            {
                schemasMicrosoftComVml.CTTextbox old = CTShapeImpl.this.getTextboxArray(i);
                CTShapeImpl.this.setTextboxArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTTextbox o)
                { CTShapeImpl.this.insertNewTextbox(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTTextPath> getTextpathList()
    {
        final class TextpathList extends java.util.AbstractList<schemasMicrosoftComVml.CTTextPath>
        {
            ...
            {
                schemasMicrosoftComVml.CTTextPath old = CTShapeImpl.this.getTextpathArray(i);
                CTShapeImpl.this.setTextpathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTTextPath o)
                { CTShapeImpl.this.insertNewTextpath(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTImageData> getImagedataList()
    {
        final class ImagedataList extends java.util.AbstractList<schemasMicrosoftComVml.CTImageData>
        {
            ...
            {
                schemasMicrosoftComVml.CTImageData old = CTShapeImpl.this.getImagedataArray(i);
                CTShapeImpl.this.setImagedataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTImageData o)
                { CTShapeImpl.this.insertNewImagedata(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTSkew> getSkewList()
    {
        final class SkewList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTSkew>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTSkew old = CTShapeImpl.this.getSkewArray(i);
                CTShapeImpl.this.setSkewArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTSkew o)
                { CTShapeImpl.this.insertNewSkew(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTExtrusion> getExtrusionList()
    {
        final class ExtrusionList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTExtrusion>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTExtrusion old = CTShapeImpl.this.getExtrusionArray(i);
                CTShapeImpl.this.setExtrusionArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTExtrusion o)
                { CTShapeImpl.this.insertNewExtrusion(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTCallout> getCalloutList()
    {
        final class CalloutList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTCallout>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTCallout old = CTShapeImpl.this.getCalloutArray(i);
                CTShapeImpl.this.setCalloutArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTCallout o)
                { CTShapeImpl.this.insertNewCallout(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTLock> getLockList()
    {
        final class LockList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTLock>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTLock old = CTShapeImpl.this.getLockArray(i);
                CTShapeImpl.this.setLockArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTLock o)
                { CTShapeImpl.this.insertNewLock(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTClipPath> getClippathList()
    {
        final class ClippathList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTClipPath>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTClipPath old = CTShapeImpl.this.getClippathArray(i);
                CTShapeImpl.this.setClippathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTClipPath o)
                { CTShapeImpl.this.insertNewClippath(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTSignatureLine> getSignaturelineList()
    {
        final class SignaturelineList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTSignatureLine>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTSignatureLine old = CTShapeImpl.this.getSignaturelineArray(i);
                CTShapeImpl.this.setSignaturelineArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTSignatureLine o)
                { CTShapeImpl.this.insertNewSignatureline(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTWrap> getWrapList()
    {
        final class WrapList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTWrap>
        {
            ...
            {
                schemasMicrosoftComOfficeWord.CTWrap old = CTShapeImpl.this.getWrapArray(i);
                CTShapeImpl.this.setWrapArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTWrap o)
                { CTShapeImpl.this.insertNewWrap(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTAnchorLock> getAnchorlockList()
    {
        final class AnchorlockList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTAnchorLock>
        {
            ...
            {
                schemasMicrosoftComOfficeWord.CTAnchorLock old = CTShapeImpl.this.getAnchorlockArray(i);
                CTShapeImpl.this.setAnchorlockArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTAnchorLock o)
                { CTShapeImpl.this.insertNewAnchorlock(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBordertopList()
    {
        final class BordertopList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTBorder>
        {
            ...
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTShapeImpl.this.getBordertopArray(i);
                CTShapeImpl.this.setBordertopArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTShapeImpl.this.insertNewBordertop(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderbottomList()
    {
        final class BorderbottomList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTBorder>
        {
            ...
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTShapeImpl.this.getBorderbottomArray(i);
                CTShapeImpl.this.setBorderbottomArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTShapeImpl.this.insertNewBorderbottom(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderleftList()
    {
        final class BorderleftList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTBorder>
        {
            ...
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTShapeImpl.this.getBorderleftArray(i);
                CTShapeImpl.this.setBorderleftArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTShapeImpl.this.insertNewBorderleft(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderrightList()
    {
        final class BorderrightList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTBorder>
        {
            ...
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTShapeImpl.this.getBorderrightArray(i);
                CTShapeImpl.this.setBorderrightArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTShapeImpl.this.insertNewBorderright(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeExcel.CTClientData> getClientDataList()
    {
        final class ClientDataList extends java.util.AbstractList<schemasMicrosoftComOfficeExcel.CTClientData>
        {
            ...
            {
                schemasMicrosoftComOfficeExcel.CTClientData old = CTShapeImpl.this.getClientDataArray(i);
                CTShapeImpl.this.setClientDataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeExcel.CTClientData o)
                { CTShapeImpl.this.insertNewClientData(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficePowerpoint.CTRel> getTextdataList()
    {
        final class TextdataList extends java.util.AbstractList<schemasMicrosoftComOfficePowerpoint.CTRel>
        {
            ...
            {
                schemasMicrosoftComOfficePowerpoint.CTRel old = CTShapeImpl.this.getTextdataArray(i);
                CTShapeImpl.this.setTextdataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficePowerpoint.CTRel o)
                { CTShapeImpl.this.insertNewTextdata(i).set(o); }
     ...
     */
    public java.util.List<schemasMicrosoftComOfficeOffice.CTInk> getInkList()
    {
        final class InkList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTInk>
        {
            public schemasMicrosoftComOfficeOffice.CTInk get(int i)
                { return CTShapeImpl.this.getInkArray(i); }
            
            public schemasMicrosoftComOfficeOffice.CTInk set(int i, schemasMicrosoftComOfficeOffice.CTInk o)
            {
                schemasMicrosoftComOfficeOffice.CTInk old = CTShapeImpl.this.getInkArray(i);
                CTShapeImpl.this.setInkArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTInk o)
                { CTShapeImpl.this.insertNewInk(i).set(o); }
            
            public schemasMicrosoftComOfficeOffice.CTInk remove(int i)
            {
                schemasMicrosoftComOfficeOffice.CTInk old = CTShapeImpl.this.getInkArray(i);
     ...
     */
    public schemasMicrosoftComOfficeOffice.CTInk[] getInkArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(INK$46, targetList);
            schemasMicrosoftComOfficeOffice.CTInk[] result = new schemasMicrosoftComOfficeOffice.CTInk[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public schemasMicrosoftComOfficeOffice.CTInk getInkArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.CTInk target = null;
            target = (schemasMicrosoftComOfficeOffice.CTInk)get_store().find_element_user(INK$46, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setInkArray(schemasMicrosoftComOfficeOffice.CTInk[] inkArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setInkArray(int i, schemasMicrosoftComOfficeOffice.CTInk ink)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public schemasMicrosoftComOfficeOffice.CTInk insertNewInk(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.CTInk target = null;
            target = (schemasMicrosoftComOfficeOffice.CTInk)get_store().insert_element_user(INK$46, i);
            return target;
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.CTInk addNewInk()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.CTInk target = null;
            target = (schemasMicrosoftComOfficeOffice.CTInk)get_store().add_element_user(INK$46);
            return target;
        }
    }
     ...
     */
    public java.util.List<schemasMicrosoftComOfficePowerpoint.CTEmpty> getIscommentList()
    {
        final class IscommentList extends java.util.AbstractList<schemasMicrosoftComOfficePowerpoint.CTEmpty>
        {
            public schemasMicrosoftComOfficePowerpoint.CTEmpty get(int i)
                { return CTShapeImpl.this.getIscommentArray(i); }
            
            public schemasMicrosoftComOfficePowerpoint.CTEmpty set(int i, schemasMicrosoftComOfficePowerpoint.CTEmpty o)
            {
                schemasMicrosoftComOfficePowerpoint.CTEmpty old = CTShapeImpl.this.getIscommentArray(i);
                CTShapeImpl.this.setIscommentArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficePowerpoint.CTEmpty o)
                { CTShapeImpl.this.insertNewIscomment(i).set(o); }
            
            public schemasMicrosoftComOfficePowerpoint.CTEmpty remove(int i)
            {
                schemasMicrosoftComOfficePowerpoint.CTEmpty old = CTShapeImpl.this.getIscommentArray(i);
     ...
     */
    public schemasMicrosoftComOfficePowerpoint.CTEmpty[] getIscommentArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(ISCOMMENT$48, targetList);
            schemasMicrosoftComOfficePowerpoint.CTEmpty[] result = new schemasMicrosoftComOfficePowerpoint.CTEmpty[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public schemasMicrosoftComOfficePowerpoint.CTEmpty getIscommentArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficePowerpoint.CTEmpty target = null;
            target = (schemasMicrosoftComOfficePowerpoint.CTEmpty)get_store().find_element_user(ISCOMMENT$48, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
     ...
     */
    public void setIscommentArray(schemasMicrosoftComOfficePowerpoint.CTEmpty[] iscommentArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
            arraySetterHelper(iscommentArray, ISCOMMENT$48);
        }
    }
     ...
     */
    public void setIscommentArray(int i, schemasMicrosoftComOfficePowerpoint.CTEmpty iscomment)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public schemasMicrosoftComOfficePowerpoint.CTEmpty insertNewIscomment(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficePowerpoint.CTEmpty target = null;
            target = (schemasMicrosoftComOfficePowerpoint.CTEmpty)get_store().insert_element_user(ISCOMMENT$48, i);
            return target;
        }
    }
    ...
    public schemasMicrosoftComOfficePowerpoint.CTEmpty addNewIscomment()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficePowerpoint.CTEmpty target = null;
            target = (schemasMicrosoftComOfficePowerpoint.CTEmpty)get_store().add_element_user(ISCOMMENT$48);
            return target;
        }
    }
    ...
    public java.lang.String getId()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ID$50);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetId()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(ID$50);
            return target;
        }
    }
    ...
    public void setId(java.lang.String id)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ID$50);
            }
    ...
    public void xsetId(org.apache.xmlbeans.XmlString id)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(ID$50);
            }
            target.set(id);
        }
    }
    ...
    public java.lang.String getStyle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(STYLE$52);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetStyle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(STYLE$52);
            return target;
        }
    }
    ...
    public void setStyle(java.lang.String style)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(STYLE$52);
            }
    ...
    public void xsetStyle(org.apache.xmlbeans.XmlString style)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(STYLE$52);
            }
            target.set(style);
        }
    }
    ...
    public java.lang.String getTarget()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(TARGET$56);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetTarget()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(TARGET$56);
            return target;
        }
    }
    ...
    public void setTarget(java.lang.String targetValue)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(TARGET$56);
            }
    ...
    public void xsetTarget(org.apache.xmlbeans.XmlString targetValue)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(TARGET$56);
            }
    ...
    public java.lang.String getClass1()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(CLASS1$58);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetClass1()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(CLASS1$58);
            return target;
        }
    }
    ...
    public void setClass1(java.lang.String class1)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(CLASS1$58);
            }
    ...
    public void xsetClass1(org.apache.xmlbeans.XmlString class1)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(CLASS1$58);
            }
            target.set(class1);
        }
    }
    ...
    public java.lang.String getTitle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(TITLE$60);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetTitle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(TITLE$60);
            return target;
        }
    }
    ...
    public void setTitle(java.lang.String title)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(TITLE$60);
            }
    ...
    public void xsetTitle(org.apache.xmlbeans.XmlString title)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(TITLE$60);
            }
            target.set(title);
        }
    }
    ...
    public java.lang.String getAlt()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ALT$62);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetAlt()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(ALT$62);
            return target;
        }
    }
    ...
    public void setAlt(java.lang.String alt)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ALT$62);
            }
    ...
    public void xsetAlt(org.apache.xmlbeans.XmlString alt)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(ALT$62);
            }
            target.set(alt);
        }
    }
    ...
    public java.lang.String getCoordsize()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(COORDSIZE$64);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetCoordsize()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(COORDSIZE$64);
            return target;
        }
    }
    ...
    public void setCoordsize(java.lang.String coordsize)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(COORDSIZE$64);
            }
    ...
    public void xsetCoordsize(org.apache.xmlbeans.XmlString coordsize)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(COORDSIZE$64);
            }
    ...
    public java.lang.String getCoordorigin()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(COORDORIGIN$66);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetCoordorigin()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(COORDORIGIN$66);
            return target;
        }
    }
    ...
    public void setCoordorigin(java.lang.String coordorigin)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(COORDORIGIN$66);
            }
    ...
    public void xsetCoordorigin(org.apache.xmlbeans.XmlString coordorigin)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(COORDORIGIN$66);
            }
    ...
    public java.lang.String getWrapcoords()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(WRAPCOORDS$68);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetWrapcoords()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(WRAPCOORDS$68);
            return target;
        }
    }
    ...
    public void setWrapcoords(java.lang.String wrapcoords)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(WRAPCOORDS$68);
            }
    ...
    public void xsetWrapcoords(org.apache.xmlbeans.XmlString wrapcoords)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(WRAPCOORDS$68);
            }
    ...
    public schemasMicrosoftComVml.STTrueFalse.Enum getPrint()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(PRINT$70);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComVml.STTrueFalse xgetPrint()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComVml.STTrueFalse)get_store().find_attribute_user(PRINT$70);
            return target;
        }
    }
    ...
    public void setPrint(schemasMicrosoftComVml.STTrueFalse.Enum print)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(PRINT$70);
            }
    ...
    public void xsetPrint(schemasMicrosoftComVml.STTrueFalse print)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STTrueFalse)get_store().add_attribute_user(PRINT$70);
            }
            target.set(print);
        }
    }
    ...
    public java.lang.String getSpid()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(SPID$72);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetSpid()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(SPID$72);
            return target;
        }
    }
    ...
    public void setSpid(java.lang.String spid)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(SPID$72);
            }
    ...
    public void xsetSpid(org.apache.xmlbeans.XmlString spid)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(SPID$72);
            }
            target.set(spid);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getOned()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ONED$74);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetOned()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(ONED$74);
            return target;
        }
    }
    ...
    public void setOned(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum oned)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ONED$74);
            }
    ...
    public void xsetOned(schemasMicrosoftComOfficeOffice.STTrueFalse oned)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(ONED$74);
            }
            target.set(oned);
        }
    }
    ...
    public java.math.BigInteger getRegroupid()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(REGROUPID$76);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlInteger xgetRegroupid()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlInteger)get_store().find_attribute_user(REGROUPID$76);
            return target;
        }
    }
    ...
    public void setRegroupid(java.math.BigInteger regroupid)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(REGROUPID$76);
            }
    ...
    public void xsetRegroupid(org.apache.xmlbeans.XmlInteger regroupid)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlInteger)get_store().add_attribute_user(REGROUPID$76);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getDoubleclicknotify()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(DOUBLECLICKNOTIFY$78);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetDoubleclicknotify()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(DOUBLECLICKNOTIFY$78);
            return target;
        }
    }
    ...
    public void setDoubleclicknotify(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum doubleclicknotify)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(DOUBLECLICKNOTIFY$78);
            }
    ...
    public void xsetDoubleclicknotify(schemasMicrosoftComOfficeOffice.STTrueFalse doubleclicknotify)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(DOUBLECLICKNOTIFY$78);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getButton()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(BUTTON$80);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetButton()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(BUTTON$80);
            return target;
        }
    }
    ...
    public void setButton(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum button)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(BUTTON$80);
            }
    ...
    public void xsetButton(schemasMicrosoftComOfficeOffice.STTrueFalse button)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(BUTTON$80);
            }
            target.set(button);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getUserhidden()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(USERHIDDEN$82);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetUserhidden()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(USERHIDDEN$82);
            return target;
        }
    }
    ...
    public void setUserhidden(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum userhidden)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(USERHIDDEN$82);
            }
    ...
    public void xsetUserhidden(schemasMicrosoftComOfficeOffice.STTrueFalse userhidden)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(USERHIDDEN$82);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getBullet()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(BULLET$84);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetBullet()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(BULLET$84);
            return target;
        }
    }
    ...
    public void setBullet(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum bullet)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(BULLET$84);
            }
    ...
    public void xsetBullet(schemasMicrosoftComOfficeOffice.STTrueFalse bullet)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(BULLET$84);
            }
            target.set(bullet);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getHr()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(HR$86);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetHr()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(HR$86);
            return target;
        }
    }
    ...
    public void setHr(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum hr)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(HR$86);
            }
    ...
    public void xsetHr(schemasMicrosoftComOfficeOffice.STTrueFalse hr)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(HR$86);
            }
            target.set(hr);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getHrstd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(HRSTD$88);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetHrstd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(HRSTD$88);
            return target;
        }
    }
    ...
    public void setHrstd(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum hrstd)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(HRSTD$88);
            }
    ...
    public void xsetHrstd(schemasMicrosoftComOfficeOffice.STTrueFalse hrstd)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(HRSTD$88);
            }
            target.set(hrstd);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getHrnoshade()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(HRNOSHADE$90);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetHrnoshade()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(HRNOSHADE$90);
            return target;
        }
    }
    ...
    public void setHrnoshade(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum hrnoshade)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(HRNOSHADE$90);
            }
    ...
    public void xsetHrnoshade(schemasMicrosoftComOfficeOffice.STTrueFalse hrnoshade)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(HRNOSHADE$90);
            }
    ...
    public float getHrpct()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(HRPCT$92);
            if (target == null)
            {
                return 0.0f;
            }
    ...
    public org.apache.xmlbeans.XmlFloat xgetHrpct()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlFloat)get_store().find_attribute_user(HRPCT$92);
            return target;
        }
    }
    ...
    public void setHrpct(float hrpct)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(HRPCT$92);
            }
    ...
    public void xsetHrpct(org.apache.xmlbeans.XmlFloat hrpct)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlFloat)get_store().add_attribute_user(HRPCT$92);
            }
            target.set(hrpct);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STHrAlign.Enum getHralign()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(HRALIGN$94);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(HRALIGN$94);
            }
            if (target == null)
            {
                return null;
    ...
    public schemasMicrosoftComOfficeOffice.STHrAlign xgetHralign()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.STHrAlign)get_store().find_attribute_user(HRALIGN$94);
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STHrAlign)get_default_attribute_value(HRALIGN$94);
            }
            return target;
        }
    }
    ...
    public void setHralign(schemasMicrosoftComOfficeOffice.STHrAlign.Enum hralign)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(HRALIGN$94);
            }
    ...
    public void xsetHralign(schemasMicrosoftComOfficeOffice.STHrAlign hralign)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STHrAlign)get_store().add_attribute_user(HRALIGN$94);
            }
            target.set(hralign);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getAllowincell()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ALLOWINCELL$96);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetAllowincell()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(ALLOWINCELL$96);
            return target;
        }
    }
    ...
    public void setAllowincell(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum allowincell)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ALLOWINCELL$96);
            }
    ...
    public void xsetAllowincell(schemasMicrosoftComOfficeOffice.STTrueFalse allowincell)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(ALLOWINCELL$96);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getAllowoverlap()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ALLOWOVERLAP$98);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetAllowoverlap()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(ALLOWOVERLAP$98);
            return target;
        }
    }
    ...
    public void setAllowoverlap(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum allowoverlap)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ALLOWOVERLAP$98);
            }
    ...
    public void xsetAllowoverlap(schemasMicrosoftComOfficeOffice.STTrueFalse allowoverlap)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(ALLOWOVERLAP$98);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getUserdrawn()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(USERDRAWN$100);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetUserdrawn()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(USERDRAWN$100);
            return target;
        }
    }
    ...
    public void setUserdrawn(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum userdrawn)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(USERDRAWN$100);
            }
    ...
    public void xsetUserdrawn(schemasMicrosoftComOfficeOffice.STTrueFalse userdrawn)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(USERDRAWN$100);
            }
    ...
    public java.lang.String getBordertopcolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(BORDERTOPCOLOR$102);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetBordertopcolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(BORDERTOPCOLOR$102);
            return target;
        }
    }
    ...
    public void setBordertopcolor(java.lang.String bordertopcolor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(BORDERTOPCOLOR$102);
            }
    ...
    public void xsetBordertopcolor(org.apache.xmlbeans.XmlString bordertopcolor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(BORDERTOPCOLOR$102);
            }
    ...
    public java.lang.String getBorderleftcolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(BORDERLEFTCOLOR$104);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetBorderleftcolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(BORDERLEFTCOLOR$104);
            return target;
        }
    }
    ...
    public void setBorderleftcolor(java.lang.String borderleftcolor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(BORDERLEFTCOLOR$104);
            }
    ...
    public void xsetBorderleftcolor(org.apache.xmlbeans.XmlString borderleftcolor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(BORDERLEFTCOLOR$104);
            }
    ...
    public java.lang.String getBorderbottomcolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(BORDERBOTTOMCOLOR$106);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetBorderbottomcolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(BORDERBOTTOMCOLOR$106);
            return target;
        }
    }
    ...
    public void setBorderbottomcolor(java.lang.String borderbottomcolor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(BORDERBOTTOMCOLOR$106);
            }
    ...
    public void xsetBorderbottomcolor(org.apache.xmlbeans.XmlString borderbottomcolor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(BORDERBOTTOMCOLOR$106);
            }
    ...
    public java.lang.String getBorderrightcolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(BORDERRIGHTCOLOR$108);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetBorderrightcolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(BORDERRIGHTCOLOR$108);
            return target;
        }
    }
    ...
    public void setBorderrightcolor(java.lang.String borderrightcolor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(BORDERRIGHTCOLOR$108);
            }
    ...
    public void xsetBorderrightcolor(org.apache.xmlbeans.XmlString borderrightcolor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(BORDERRIGHTCOLOR$108);
            }
    ...
    public java.math.BigInteger getDgmlayout()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(DGMLAYOUT$110);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlInteger xgetDgmlayout()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlInteger target = null;
            target = (org.apache.xmlbeans.XmlInteger)get_store().find_attribute_user(DGMLAYOUT$110);
            return target;
        }
    }
    ...
    public void setDgmlayout(java.math.BigInteger dgmlayout)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(DGMLAYOUT$110);
            }
    ...
    public void xsetDgmlayout(org.apache.xmlbeans.XmlInteger dgmlayout)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlInteger)get_store().add_attribute_user(DGMLAYOUT$110);
            }
    ...
    public java.math.BigInteger getDgmnodekind()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(DGMNODEKIND$112);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlInteger xgetDgmnodekind()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlInteger target = null;
            target = (org.apache.xmlbeans.XmlInteger)get_store().find_attribute_user(DGMNODEKIND$112);
            return target;
        }
    }
    ...
    public void setDgmnodekind(java.math.BigInteger dgmnodekind)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(DGMNODEKIND$112);
            }
    ...
    public void xsetDgmnodekind(org.apache.xmlbeans.XmlInteger dgmnodekind)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlInteger)get_store().add_attribute_user(DGMNODEKIND$112);
            }
    ...
    public java.math.BigInteger getDgmlayoutmru()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(DGMLAYOUTMRU$114);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlInteger xgetDgmlayoutmru()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlInteger target = null;
            target = (org.apache.xmlbeans.XmlInteger)get_store().find_attribute_user(DGMLAYOUTMRU$114);
            return target;
        }
    }
    ...
    public void setDgmlayoutmru(java.math.BigInteger dgmlayoutmru)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(DGMLAYOUTMRU$114);
            }
    ...
    public void xsetDgmlayoutmru(org.apache.xmlbeans.XmlInteger dgmlayoutmru)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlInteger)get_store().add_attribute_user(DGMLAYOUTMRU$114);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STInsetMode.Enum getInsetmode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(INSETMODE$116);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(INSETMODE$116);
            }
            if (target == null)
            {
                return null;
    ...
    public schemasMicrosoftComOfficeOffice.STInsetMode xgetInsetmode()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.STInsetMode)get_store().find_attribute_user(INSETMODE$116);
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STInsetMode)get_default_attribute_value(INSETMODE$116);
            }
            return target;
        }
    }
    ...
    public void setInsetmode(schemasMicrosoftComOfficeOffice.STInsetMode.Enum insetmode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(INSETMODE$116);
            }
    ...
    public void xsetInsetmode(schemasMicrosoftComOfficeOffice.STInsetMode insetmode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STInsetMode)get_store().add_attribute_user(INSETMODE$116);
            }
    ...
    public java.lang.String getChromakey()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(CHROMAKEY$118);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComVml.STColorType xgetChromakey()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComVml.STColorType)get_store().find_attribute_user(CHROMAKEY$118);
            return target;
        }
    }
    ...
    public void setChromakey(java.lang.String chromakey)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(CHROMAKEY$118);
            }
    ...
    public void xsetChromakey(schemasMicrosoftComVml.STColorType chromakey)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STColorType)get_store().add_attribute_user(CHROMAKEY$118);
            }
    ...
    public schemasMicrosoftComVml.STTrueFalse.Enum getFilled()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(FILLED$120);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComVml.STTrueFalse xgetFilled()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STTrueFalse target = null;
            target = (schemasMicrosoftComVml.STTrueFalse)get_store().find_attribute_user(FILLED$120);
            return target;
        }
    }
    ...
    public void setFilled(schemasMicrosoftComVml.STTrueFalse.Enum filled)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(FILLED$120);
            }
    ...
    public void xsetFilled(schemasMicrosoftComVml.STTrueFalse filled)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STTrueFalse)get_store().add_attribute_user(FILLED$120);
            }
            target.set(filled);
        }
    }
    ...
    public java.lang.String getFillcolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(FILLCOLOR$122);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComVml.STColorType xgetFillcolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STColorType target = null;
            target = (schemasMicrosoftComVml.STColorType)get_store().find_attribute_user(FILLCOLOR$122);
            return target;
        }
    }
    ...
    public void setFillcolor(java.lang.String fillcolor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(FILLCOLOR$122);
            }
    ...
    public void xsetFillcolor(schemasMicrosoftComVml.STColorType fillcolor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STColorType)get_store().add_attribute_user(FILLCOLOR$122);
            }
    ...
    public java.lang.String getOpacity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(OPACITY$124);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetOpacity()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(OPACITY$124);
            return target;
        }
    }
    ...
    public void setOpacity(java.lang.String opacity)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(OPACITY$124);
            }
    ...
    public void xsetOpacity(org.apache.xmlbeans.XmlString opacity)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(OPACITY$124);
            }
            target.set(opacity);
        }
    }
    ...
    public schemasMicrosoftComVml.STTrueFalse.Enum getStroked()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(STROKED$126);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComVml.STTrueFalse xgetStroked()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STTrueFalse target = null;
            target = (schemasMicrosoftComVml.STTrueFalse)get_store().find_attribute_user(STROKED$126);
            return target;
        }
    }
    ...
    public void setStroked(schemasMicrosoftComVml.STTrueFalse.Enum stroked)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(STROKED$126);
            }
    ...
    public void xsetStroked(schemasMicrosoftComVml.STTrueFalse stroked)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STTrueFalse)get_store().add_attribute_user(STROKED$126);
            }
            target.set(stroked);
        }
    }
    ...
    public java.lang.String getStrokecolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(STROKECOLOR$128);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComVml.STColorType xgetStrokecolor()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STColorType target = null;
            target = (schemasMicrosoftComVml.STColorType)get_store().find_attribute_user(STROKECOLOR$128);
            return target;
        }
    }
    ...
    public void setStrokecolor(java.lang.String strokecolor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(STROKECOLOR$128);
            }
    ...
    public void xsetStrokecolor(schemasMicrosoftComVml.STColorType strokecolor)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STColorType)get_store().add_attribute_user(STROKECOLOR$128);
            }
    ...
    public java.lang.String getStrokeweight()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(STROKEWEIGHT$130);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetStrokeweight()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(STROKEWEIGHT$130);
            return target;
        }
    }
    ...
    public void setStrokeweight(java.lang.String strokeweight)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(STROKEWEIGHT$130);
            }
    ...
    public void xsetStrokeweight(org.apache.xmlbeans.XmlString strokeweight)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(STROKEWEIGHT$130);
            }
    ...
    public schemasMicrosoftComVml.STTrueFalse.Enum getInsetpen()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(INSETPEN$132);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComVml.STTrueFalse xgetInsetpen()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComVml.STTrueFalse target = null;
            target = (schemasMicrosoftComVml.STTrueFalse)get_store().find_attribute_user(INSETPEN$132);
            return target;
        }
    }
    ...
    public void setInsetpen(schemasMicrosoftComVml.STTrueFalse.Enum insetpen)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(INSETPEN$132);
            }
    ...
    public void xsetInsetpen(schemasMicrosoftComVml.STTrueFalse insetpen)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComVml.STTrueFalse)get_store().add_attribute_user(INSETPEN$132);
            }
            target.set(insetpen);
        }
    }
    ...
    public float getSpt()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(SPT$134);
            if (target == null)
            {
                return 0.0f;
            }
    ...
    public org.apache.xmlbeans.XmlFloat xgetSpt()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlFloat target = null;
            target = (org.apache.xmlbeans.XmlFloat)get_store().find_attribute_user(SPT$134);
            return target;
        }
    }
    ...
    public void setSpt(float spt)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(SPT$134);
            }
    ...
    public void xsetSpt(org.apache.xmlbeans.XmlFloat spt)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlFloat)get_store().add_attribute_user(SPT$134);
            }
            target.set(spt);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STConnectorType.Enum getConnectortype()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(CONNECTORTYPE$136);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(CONNECTORTYPE$136);
            }
            if (target == null)
            {
                return null;
    ...
    public schemasMicrosoftComOfficeOffice.STConnectorType xgetConnectortype()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.STConnectorType)get_store().find_attribute_user(CONNECTORTYPE$136);
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STConnectorType)get_default_attribute_value(CONNECTORTYPE$136);
            }
            return target;
        }
    }
    ...
    public void setConnectortype(schemasMicrosoftComOfficeOffice.STConnectorType.Enum connectortype)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(CONNECTORTYPE$136);
            }
    ...
    public void xsetConnectortype(schemasMicrosoftComOfficeOffice.STConnectorType connectortype)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STConnectorType)get_store().add_attribute_user(CONNECTORTYPE$136);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STBWMode.Enum getBwmode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(BWMODE$138);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STBWMode xgetBwmode()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.STBWMode)get_store().find_attribute_user(BWMODE$138);
            return target;
        }
    }
    ...
    public void setBwmode(schemasMicrosoftComOfficeOffice.STBWMode.Enum bwmode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(BWMODE$138);
            }
    ...
    public void xsetBwmode(schemasMicrosoftComOfficeOffice.STBWMode bwmode)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STBWMode)get_store().add_attribute_user(BWMODE$138);
            }
            target.set(bwmode);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STBWMode.Enum getBwpure()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(BWPURE$140);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STBWMode xgetBwpure()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STBWMode target = null;
            target = (schemasMicrosoftComOfficeOffice.STBWMode)get_store().find_attribute_user(BWPURE$140);
            return target;
        }
    }
    ...
    public void setBwpure(schemasMicrosoftComOfficeOffice.STBWMode.Enum bwpure)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(BWPURE$140);
            }
    ...
    public void xsetBwpure(schemasMicrosoftComOfficeOffice.STBWMode bwpure)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STBWMode)get_store().add_attribute_user(BWPURE$140);
            }
            target.set(bwpure);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STBWMode.Enum getBwnormal()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(BWNORMAL$142);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STBWMode xgetBwnormal()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STBWMode target = null;
            target = (schemasMicrosoftComOfficeOffice.STBWMode)get_store().find_attribute_user(BWNORMAL$142);
            return target;
        }
    }
    ...
    public void setBwnormal(schemasMicrosoftComOfficeOffice.STBWMode.Enum bwnormal)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(BWNORMAL$142);
            }
    ...
    public void xsetBwnormal(schemasMicrosoftComOfficeOffice.STBWMode bwnormal)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STBWMode)get_store().add_attribute_user(BWNORMAL$142);
            }
            target.set(bwnormal);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getForcedash()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(FORCEDASH$144);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetForcedash()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(FORCEDASH$144);
            return target;
        }
    }
    ...
    public void setForcedash(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum forcedash)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(FORCEDASH$144);
            }
    ...
    public void xsetForcedash(schemasMicrosoftComOfficeOffice.STTrueFalse forcedash)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(FORCEDASH$144);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getOleicon()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(OLEICON$146);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetOleicon()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(OLEICON$146);
            return target;
        }
    }
    ...
    public void setOleicon(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum oleicon)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(OLEICON$146);
            }
    ...
    public void xsetOleicon(schemasMicrosoftComOfficeOffice.STTrueFalse oleicon)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(OLEICON$146);
            }
            target.set(oleicon);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalseBlank.Enum getOle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(OLE$148);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalseBlank xgetOle()
    {
        synchronized (monitor())
        {
            ...
            target = (schemasMicrosoftComOfficeOffice.STTrueFalseBlank)get_store().find_attribute_user(OLE$148);
            return target;
        }
    }
    ...
    public void setOle(schemasMicrosoftComOfficeOffice.STTrueFalseBlank.Enum ole)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(OLE$148);
            }
    ...
    public void xsetOle(schemasMicrosoftComOfficeOffice.STTrueFalseBlank ole)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalseBlank)get_store().add_attribute_user(OLE$148);
            }
            target.set(ole);
        }
    }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getPreferrelative()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(PREFERRELATIVE$150);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetPreferrelative()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(PREFERRELATIVE$150);
            return target;
        }
    }
    ...
    public void setPreferrelative(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum preferrelative)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(PREFERRELATIVE$150);
            }
    ...
    public void xsetPreferrelative(schemasMicrosoftComOfficeOffice.STTrueFalse preferrelative)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(PREFERRELATIVE$150);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getCliptowrap()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(CLIPTOWRAP$152);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetCliptowrap()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(CLIPTOWRAP$152);
            return target;
        }
    }
    ...
    public void setCliptowrap(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum cliptowrap)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(CLIPTOWRAP$152);
            }
    ...
    public void xsetCliptowrap(schemasMicrosoftComOfficeOffice.STTrueFalse cliptowrap)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(CLIPTOWRAP$152);
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse.Enum getClip()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(CLIP$154);
            if (target == null)
            {
                return null;
            }
    ...
    public schemasMicrosoftComOfficeOffice.STTrueFalse xgetClip()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalse target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().find_attribute_user(CLIP$154);
            return target;
        }
    }
    ...
    public void setClip(schemasMicrosoftComOfficeOffice.STTrueFalse.Enum clip)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(CLIP$154);
            }
    ...
    public void xsetClip(schemasMicrosoftComOfficeOffice.STTrueFalse clip)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalse)get_store().add_attribute_user(CLIP$154);
            }
            target.set(clip);
        }
    }
    ...
    public java.lang.String getType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(TYPE$156);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(TYPE$156);
            return target;
        }
    }
    ...
    public void setType(java.lang.String type)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(TYPE$156);
            }
    ...
    public void xsetType(org.apache.xmlbeans.XmlString type)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(TYPE$156);
            }
            target.set(type);
        }
    }
    ...
    public java.lang.String getAdj()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ADJ$158);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public org.apache.xmlbeans.XmlString xgetAdj()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(ADJ$158);
            return target;
        }
    }
     ...
     */
    public void setAdj(java.lang.String adj)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ADJ$158);
            }
     ...
     */
    public void xsetAdj(org.apache.xmlbeans.XmlString adj)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(ADJ$158);
            }
            target.set(adj);
        }
    }
    ...
    public java.lang.String getPath2()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(PATH2$160);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetPath2()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(PATH2$160);
            return target;
        }
    }
    ...
    public void setPath2(java.lang.String path2)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(PATH2$160);
            }
    ...
    public void xsetPath2(org.apache.xmlbeans.XmlString path2)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(PATH2$160);
            }
            target.set(path2);
        }
    }
    ...
    public byte[] getGfxdata()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(GFXDATA$162);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlBase64Binary xgetGfxdata()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlBase64Binary)get_store().find_attribute_user(GFXDATA$162);
            return target;
        }
    }
    ...
    public void setGfxdata(byte[] gfxdata)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(GFXDATA$162);
            }
    ...
    public void xsetGfxdata(org.apache.xmlbeans.XmlBase64Binary gfxdata)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBase64Binary)get_store().add_attribute_user(GFXDATA$162);
            }
            target.set(gfxdata);
        }
    }
    ...
    public java.lang.String getEquationxml()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(EQUATIONXML$164);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public org.apache.xmlbeans.XmlString xgetEquationxml()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(EQUATIONXML$164);
            return target;
        }
    }
     ...
     */
    public void setEquationxml(java.lang.String equationxml)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(EQUATIONXML$164);
            }
            target.setStringValue(equationxml);
        }
    }
     ...
     */
    public void xsetEquationxml(org.apache.xmlbeans.XmlString equationxml)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(EQUATIONXML$164);
            }
            target.set(equationxml);
        }
    }
