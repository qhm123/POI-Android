/*
 * XML Type:  CT_RoundRect
 * Namespace: urn:schemas-microsoft-com:vml
 * Java type: schemasMicrosoftComVml.CTRoundRect
 *
 * Automatically generated - do not modify.
 */
package schemasMicrosoftComVml.impl;
/**
 * An XML CT_RoundRect(@urn:schemas-microsoft-com:vml).
 *
 * This is a complex type.
 */
public class CTRoundRectImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements schemasMicrosoftComVml.CTRoundRect
{
    
    public CTRoundRectImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName ARCSIZE$152 = 
        new javax.xml.namespace.QName("", "arcsize");
    ...
    public java.util.List<schemasMicrosoftComVml.CTPath> getPathList()
    {
        final class PathList extends java.util.AbstractList<schemasMicrosoftComVml.CTPath>
        {
            public schemasMicrosoftComVml.CTPath get(int i)
                { return CTRoundRectImpl.this.getPathArray(i); }
            
            public schemasMicrosoftComVml.CTPath set(int i, schemasMicrosoftComVml.CTPath o)
            {
                schemasMicrosoftComVml.CTPath old = CTRoundRectImpl.this.getPathArray(i);
                CTRoundRectImpl.this.setPathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTPath o)
                { CTRoundRectImpl.this.insertNewPath(i).set(o); }
            
            public schemasMicrosoftComVml.CTPath remove(int i)
            {
                schemasMicrosoftComVml.CTPath old = CTRoundRectImpl.this.getPathArray(i);
                CTRoundRectImpl.this.removePath(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfPathArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTFormulas> getFormulasList()
    {
        final class FormulasList extends java.util.AbstractList<schemasMicrosoftComVml.CTFormulas>
        {
            public schemasMicrosoftComVml.CTFormulas get(int i)
                { return CTRoundRectImpl.this.getFormulasArray(i); }
            
            public schemasMicrosoftComVml.CTFormulas set(int i, schemasMicrosoftComVml.CTFormulas o)
            {
                schemasMicrosoftComVml.CTFormulas old = CTRoundRectImpl.this.getFormulasArray(i);
                CTRoundRectImpl.this.setFormulasArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTFormulas o)
                { CTRoundRectImpl.this.insertNewFormulas(i).set(o); }
            
            public schemasMicrosoftComVml.CTFormulas remove(int i)
            {
                schemasMicrosoftComVml.CTFormulas old = CTRoundRectImpl.this.getFormulasArray(i);
                CTRoundRectImpl.this.removeFormulas(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfFormulasArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTHandles> getHandlesList()
    {
        final class HandlesList extends java.util.AbstractList<schemasMicrosoftComVml.CTHandles>
        {
            public schemasMicrosoftComVml.CTHandles get(int i)
                { return CTRoundRectImpl.this.getHandlesArray(i); }
            
            public schemasMicrosoftComVml.CTHandles set(int i, schemasMicrosoftComVml.CTHandles o)
            {
                schemasMicrosoftComVml.CTHandles old = CTRoundRectImpl.this.getHandlesArray(i);
                CTRoundRectImpl.this.setHandlesArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTHandles o)
                { CTRoundRectImpl.this.insertNewHandles(i).set(o); }
            
            public schemasMicrosoftComVml.CTHandles remove(int i)
            {
                schemasMicrosoftComVml.CTHandles old = CTRoundRectImpl.this.getHandlesArray(i);
                CTRoundRectImpl.this.removeHandles(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfHandlesArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTFill> getFillList()
    {
        final class FillList extends java.util.AbstractList<schemasMicrosoftComVml.CTFill>
        {
            public schemasMicrosoftComVml.CTFill get(int i)
                { return CTRoundRectImpl.this.getFillArray(i); }
            
            public schemasMicrosoftComVml.CTFill set(int i, schemasMicrosoftComVml.CTFill o)
            {
                schemasMicrosoftComVml.CTFill old = CTRoundRectImpl.this.getFillArray(i);
                CTRoundRectImpl.this.setFillArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTFill o)
                { CTRoundRectImpl.this.insertNewFill(i).set(o); }
            
            public schemasMicrosoftComVml.CTFill remove(int i)
            {
                schemasMicrosoftComVml.CTFill old = CTRoundRectImpl.this.getFillArray(i);
                CTRoundRectImpl.this.removeFill(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfFillArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTStroke> getStrokeList()
    {
        final class StrokeList extends java.util.AbstractList<schemasMicrosoftComVml.CTStroke>
        {
            public schemasMicrosoftComVml.CTStroke get(int i)
                { return CTRoundRectImpl.this.getStrokeArray(i); }
            
            public schemasMicrosoftComVml.CTStroke set(int i, schemasMicrosoftComVml.CTStroke o)
            {
                schemasMicrosoftComVml.CTStroke old = CTRoundRectImpl.this.getStrokeArray(i);
                CTRoundRectImpl.this.setStrokeArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTStroke o)
                { CTRoundRectImpl.this.insertNewStroke(i).set(o); }
            
            public schemasMicrosoftComVml.CTStroke remove(int i)
            {
                schemasMicrosoftComVml.CTStroke old = CTRoundRectImpl.this.getStrokeArray(i);
                CTRoundRectImpl.this.removeStroke(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfStrokeArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTShadow> getShadowList()
    {
        final class ShadowList extends java.util.AbstractList<schemasMicrosoftComVml.CTShadow>
        {
            public schemasMicrosoftComVml.CTShadow get(int i)
                { return CTRoundRectImpl.this.getShadowArray(i); }
            
            public schemasMicrosoftComVml.CTShadow set(int i, schemasMicrosoftComVml.CTShadow o)
            {
                schemasMicrosoftComVml.CTShadow old = CTRoundRectImpl.this.getShadowArray(i);
                CTRoundRectImpl.this.setShadowArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTShadow o)
                { CTRoundRectImpl.this.insertNewShadow(i).set(o); }
            
            public schemasMicrosoftComVml.CTShadow remove(int i)
            {
                schemasMicrosoftComVml.CTShadow old = CTRoundRectImpl.this.getShadowArray(i);
                CTRoundRectImpl.this.removeShadow(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfShadowArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTTextbox> getTextboxList()
    {
        final class TextboxList extends java.util.AbstractList<schemasMicrosoftComVml.CTTextbox>
        {
            public schemasMicrosoftComVml.CTTextbox get(int i)
                { return CTRoundRectImpl.this.getTextboxArray(i); }
            
            public schemasMicrosoftComVml.CTTextbox set(int i, schemasMicrosoftComVml.CTTextbox o)
            {
                schemasMicrosoftComVml.CTTextbox old = CTRoundRectImpl.this.getTextboxArray(i);
                CTRoundRectImpl.this.setTextboxArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTTextbox o)
                { CTRoundRectImpl.this.insertNewTextbox(i).set(o); }
            
            public schemasMicrosoftComVml.CTTextbox remove(int i)
            {
                schemasMicrosoftComVml.CTTextbox old = CTRoundRectImpl.this.getTextboxArray(i);
                CTRoundRectImpl.this.removeTextbox(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfTextboxArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTTextPath> getTextpathList()
    {
        final class TextpathList extends java.util.AbstractList<schemasMicrosoftComVml.CTTextPath>
        {
            public schemasMicrosoftComVml.CTTextPath get(int i)
                { return CTRoundRectImpl.this.getTextpathArray(i); }
            
            public schemasMicrosoftComVml.CTTextPath set(int i, schemasMicrosoftComVml.CTTextPath o)
            {
                schemasMicrosoftComVml.CTTextPath old = CTRoundRectImpl.this.getTextpathArray(i);
                CTRoundRectImpl.this.setTextpathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTTextPath o)
                { CTRoundRectImpl.this.insertNewTextpath(i).set(o); }
            
            public schemasMicrosoftComVml.CTTextPath remove(int i)
            {
                schemasMicrosoftComVml.CTTextPath old = CTRoundRectImpl.this.getTextpathArray(i);
                CTRoundRectImpl.this.removeTextpath(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfTextpathArray(); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTImageData> getImagedataList()
    {
        final class ImagedataList extends java.util.AbstractList<schemasMicrosoftComVml.CTImageData>
        {
            public schemasMicrosoftComVml.CTImageData get(int i)
                { return CTRoundRectImpl.this.getImagedataArray(i); }
            
            public schemasMicrosoftComVml.CTImageData set(int i, schemasMicrosoftComVml.CTImageData o)
            {
                schemasMicrosoftComVml.CTImageData old = CTRoundRectImpl.this.getImagedataArray(i);
                CTRoundRectImpl.this.setImagedataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTImageData o)
                { CTRoundRectImpl.this.insertNewImagedata(i).set(o); }
            
            public schemasMicrosoftComVml.CTImageData remove(int i)
            {
                schemasMicrosoftComVml.CTImageData old = CTRoundRectImpl.this.getImagedataArray(i);
                CTRoundRectImpl.this.removeImagedata(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfImagedataArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTSkew> getSkewList()
    {
        final class SkewList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTSkew>
        {
            public schemasMicrosoftComOfficeOffice.CTSkew get(int i)
                { return CTRoundRectImpl.this.getSkewArray(i); }
            
            public schemasMicrosoftComOfficeOffice.CTSkew set(int i, schemasMicrosoftComOfficeOffice.CTSkew o)
            {
                schemasMicrosoftComOfficeOffice.CTSkew old = CTRoundRectImpl.this.getSkewArray(i);
                CTRoundRectImpl.this.setSkewArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTSkew o)
                { CTRoundRectImpl.this.insertNewSkew(i).set(o); }
            
            public schemasMicrosoftComOfficeOffice.CTSkew remove(int i)
            {
                schemasMicrosoftComOfficeOffice.CTSkew old = CTRoundRectImpl.this.getSkewArray(i);
                CTRoundRectImpl.this.removeSkew(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfSkewArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTExtrusion> getExtrusionList()
    {
        final class ExtrusionList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTExtrusion>
        {
            public schemasMicrosoftComOfficeOffice.CTExtrusion get(int i)
                { return CTRoundRectImpl.this.getExtrusionArray(i); }
            
            public schemasMicrosoftComOfficeOffice.CTExtrusion set(int i, schemasMicrosoftComOfficeOffice.CTExtrusion o)
            {
                schemasMicrosoftComOfficeOffice.CTExtrusion old = CTRoundRectImpl.this.getExtrusionArray(i);
                CTRoundRectImpl.this.setExtrusionArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTExtrusion o)
                { CTRoundRectImpl.this.insertNewExtrusion(i).set(o); }
            
            public schemasMicrosoftComOfficeOffice.CTExtrusion remove(int i)
            {
                schemasMicrosoftComOfficeOffice.CTExtrusion old = CTRoundRectImpl.this.getExtrusionArray(i);
                CTRoundRectImpl.this.removeExtrusion(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfExtrusionArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTCallout> getCalloutList()
    {
        final class CalloutList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTCallout>
        {
            public schemasMicrosoftComOfficeOffice.CTCallout get(int i)
                { return CTRoundRectImpl.this.getCalloutArray(i); }
            
            public schemasMicrosoftComOfficeOffice.CTCallout set(int i, schemasMicrosoftComOfficeOffice.CTCallout o)
            {
                schemasMicrosoftComOfficeOffice.CTCallout old = CTRoundRectImpl.this.getCalloutArray(i);
                CTRoundRectImpl.this.setCalloutArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTCallout o)
                { CTRoundRectImpl.this.insertNewCallout(i).set(o); }
            
            public schemasMicrosoftComOfficeOffice.CTCallout remove(int i)
            {
                schemasMicrosoftComOfficeOffice.CTCallout old = CTRoundRectImpl.this.getCalloutArray(i);
                CTRoundRectImpl.this.removeCallout(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfCalloutArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTLock> getLockList()
    {
        final class LockList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTLock>
        {
            public schemasMicrosoftComOfficeOffice.CTLock get(int i)
                { return CTRoundRectImpl.this.getLockArray(i); }
            
            public schemasMicrosoftComOfficeOffice.CTLock set(int i, schemasMicrosoftComOfficeOffice.CTLock o)
            {
                schemasMicrosoftComOfficeOffice.CTLock old = CTRoundRectImpl.this.getLockArray(i);
                CTRoundRectImpl.this.setLockArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTLock o)
                { CTRoundRectImpl.this.insertNewLock(i).set(o); }
            
            public schemasMicrosoftComOfficeOffice.CTLock remove(int i)
            {
                schemasMicrosoftComOfficeOffice.CTLock old = CTRoundRectImpl.this.getLockArray(i);
                CTRoundRectImpl.this.removeLock(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfLockArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTClipPath> getClippathList()
    {
        final class ClippathList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTClipPath>
        {
            public schemasMicrosoftComOfficeOffice.CTClipPath get(int i)
                { return CTRoundRectImpl.this.getClippathArray(i); }
            
            public schemasMicrosoftComOfficeOffice.CTClipPath set(int i, schemasMicrosoftComOfficeOffice.CTClipPath o)
            {
                schemasMicrosoftComOfficeOffice.CTClipPath old = CTRoundRectImpl.this.getClippathArray(i);
                CTRoundRectImpl.this.setClippathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTClipPath o)
                { CTRoundRectImpl.this.insertNewClippath(i).set(o); }
            
            public schemasMicrosoftComOfficeOffice.CTClipPath remove(int i)
            {
                schemasMicrosoftComOfficeOffice.CTClipPath old = CTRoundRectImpl.this.getClippathArray(i);
                CTRoundRectImpl.this.removeClippath(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfClippathArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTSignatureLine> getSignaturelineList()
    {
        final class SignaturelineList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTSignatureLine>
        {
            public schemasMicrosoftComOfficeOffice.CTSignatureLine get(int i)
                { return CTRoundRectImpl.this.getSignaturelineArray(i); }
            
            public schemasMicrosoftComOfficeOffice.CTSignatureLine set(int i, schemasMicrosoftComOfficeOffice.CTSignatureLine o)
            {
                schemasMicrosoftComOfficeOffice.CTSignatureLine old = CTRoundRectImpl.this.getSignaturelineArray(i);
                CTRoundRectImpl.this.setSignaturelineArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTSignatureLine o)
                { CTRoundRectImpl.this.insertNewSignatureline(i).set(o); }
            
            public schemasMicrosoftComOfficeOffice.CTSignatureLine remove(int i)
            {
                schemasMicrosoftComOfficeOffice.CTSignatureLine old = CTRoundRectImpl.this.getSignaturelineArray(i);
                CTRoundRectImpl.this.removeSignatureline(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfSignaturelineArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTWrap> getWrapList()
    {
        final class WrapList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTWrap>
        {
            public schemasMicrosoftComOfficeWord.CTWrap get(int i)
                { return CTRoundRectImpl.this.getWrapArray(i); }
            
            public schemasMicrosoftComOfficeWord.CTWrap set(int i, schemasMicrosoftComOfficeWord.CTWrap o)
            {
                schemasMicrosoftComOfficeWord.CTWrap old = CTRoundRectImpl.this.getWrapArray(i);
                CTRoundRectImpl.this.setWrapArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTWrap o)
                { CTRoundRectImpl.this.insertNewWrap(i).set(o); }
            
            public schemasMicrosoftComOfficeWord.CTWrap remove(int i)
            {
                schemasMicrosoftComOfficeWord.CTWrap old = CTRoundRectImpl.this.getWrapArray(i);
                CTRoundRectImpl.this.removeWrap(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfWrapArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTAnchorLock> getAnchorlockList()
    {
        final class AnchorlockList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTAnchorLock>
        {
            public schemasMicrosoftComOfficeWord.CTAnchorLock get(int i)
                { return CTRoundRectImpl.this.getAnchorlockArray(i); }
            
            public schemasMicrosoftComOfficeWord.CTAnchorLock set(int i, schemasMicrosoftComOfficeWord.CTAnchorLock o)
            {
                schemasMicrosoftComOfficeWord.CTAnchorLock old = CTRoundRectImpl.this.getAnchorlockArray(i);
                CTRoundRectImpl.this.setAnchorlockArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTAnchorLock o)
                { CTRoundRectImpl.this.insertNewAnchorlock(i).set(o); }
            
            public schemasMicrosoftComOfficeWord.CTAnchorLock remove(int i)
            {
                schemasMicrosoftComOfficeWord.CTAnchorLock old = CTRoundRectImpl.this.getAnchorlockArray(i);
                CTRoundRectImpl.this.removeAnchorlock(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfAnchorlockArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBordertopList()
    {
        final class BordertopList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTBorder>
        {
            public schemasMicrosoftComOfficeWord.CTBorder get(int i)
                { return CTRoundRectImpl.this.getBordertopArray(i); }
            
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTRoundRectImpl.this.getBordertopArray(i);
                CTRoundRectImpl.this.setBordertopArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTRoundRectImpl.this.insertNewBordertop(i).set(o); }
            
            public schemasMicrosoftComOfficeWord.CTBorder remove(int i)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTRoundRectImpl.this.getBordertopArray(i);
                CTRoundRectImpl.this.removeBordertop(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfBordertopArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderbottomList()
    {
        ...
        {
            public schemasMicrosoftComOfficeWord.CTBorder get(int i)
                { return CTRoundRectImpl.this.getBorderbottomArray(i); }
            
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTRoundRectImpl.this.getBorderbottomArray(i);
                CTRoundRectImpl.this.setBorderbottomArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTRoundRectImpl.this.insertNewBorderbottom(i).set(o); }
            
            public schemasMicrosoftComOfficeWord.CTBorder remove(int i)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTRoundRectImpl.this.getBorderbottomArray(i);
                CTRoundRectImpl.this.removeBorderbottom(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfBorderbottomArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderleftList()
    {
        ...
        {
            public schemasMicrosoftComOfficeWord.CTBorder get(int i)
                { return CTRoundRectImpl.this.getBorderleftArray(i); }
            
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTRoundRectImpl.this.getBorderleftArray(i);
                CTRoundRectImpl.this.setBorderleftArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTRoundRectImpl.this.insertNewBorderleft(i).set(o); }
            
            public schemasMicrosoftComOfficeWord.CTBorder remove(int i)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTRoundRectImpl.this.getBorderleftArray(i);
                CTRoundRectImpl.this.removeBorderleft(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfBorderleftArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderrightList()
    {
        ...
        {
            public schemasMicrosoftComOfficeWord.CTBorder get(int i)
                { return CTRoundRectImpl.this.getBorderrightArray(i); }
            
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTRoundRectImpl.this.getBorderrightArray(i);
                CTRoundRectImpl.this.setBorderrightArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTRoundRectImpl.this.insertNewBorderright(i).set(o); }
            
            public schemasMicrosoftComOfficeWord.CTBorder remove(int i)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTRoundRectImpl.this.getBorderrightArray(i);
                CTRoundRectImpl.this.removeBorderright(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfBorderrightArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficeExcel.CTClientData> getClientDataList()
    {
        final class ClientDataList extends java.util.AbstractList<schemasMicrosoftComOfficeExcel.CTClientData>
        {
            public schemasMicrosoftComOfficeExcel.CTClientData get(int i)
                { return CTRoundRectImpl.this.getClientDataArray(i); }
            
            public schemasMicrosoftComOfficeExcel.CTClientData set(int i, schemasMicrosoftComOfficeExcel.CTClientData o)
            {
                schemasMicrosoftComOfficeExcel.CTClientData old = CTRoundRectImpl.this.getClientDataArray(i);
                CTRoundRectImpl.this.setClientDataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeExcel.CTClientData o)
                { CTRoundRectImpl.this.insertNewClientData(i).set(o); }
            
            public schemasMicrosoftComOfficeExcel.CTClientData remove(int i)
            {
                schemasMicrosoftComOfficeExcel.CTClientData old = CTRoundRectImpl.this.getClientDataArray(i);
                CTRoundRectImpl.this.removeClientData(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfClientDataArray(); }
    ...
    public java.util.List<schemasMicrosoftComOfficePowerpoint.CTRel> getTextdataList()
    {
        final class TextdataList extends java.util.AbstractList<schemasMicrosoftComOfficePowerpoint.CTRel>
        {
            public schemasMicrosoftComOfficePowerpoint.CTRel get(int i)
                { return CTRoundRectImpl.this.getTextdataArray(i); }
            
            public schemasMicrosoftComOfficePowerpoint.CTRel set(int i, schemasMicrosoftComOfficePowerpoint.CTRel o)
            {
                schemasMicrosoftComOfficePowerpoint.CTRel old = CTRoundRectImpl.this.getTextdataArray(i);
                CTRoundRectImpl.this.setTextdataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficePowerpoint.CTRel o)
                { CTRoundRectImpl.this.insertNewTextdata(i).set(o); }
            
            public schemasMicrosoftComOfficePowerpoint.CTRel remove(int i)
            {
                schemasMicrosoftComOfficePowerpoint.CTRel old = CTRoundRectImpl.this.getTextdataArray(i);
                CTRoundRectImpl.this.removeTextdata(i);
                return old;
            }
            
            public int size()
                { return CTRoundRectImpl.this.sizeOfTextdataArray(); }
    ...
    /**
     * Gets the "arcsize" attribute
     */
    public java.lang.String getArcsize()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ARCSIZE$152);
            if (target == null)
            {
                return null;
            }
    ...
    /**
     * Gets (as xml) the "arcsize" attribute
     */
    public org.apache.xmlbeans.XmlString xgetArcsize()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlString target = null;
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(ARCSIZE$152);
            return target;
        }
    }
    
    /**
     * True if has "arcsize" attribute
     */
    public boolean isSetArcsize()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(ARCSIZE$152) != null;
        }
    }
    
    /**
     * Sets the "arcsize" attribute
     */
    public void setArcsize(java.lang.String arcsize)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ARCSIZE$152);
            }
    ...
    /**
     * Sets (as xml) the "arcsize" attribute
     */
    public void xsetArcsize(org.apache.xmlbeans.XmlString arcsize)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(ARCSIZE$152);
            }
            target.set(arcsize);
        }
    }
    ...
    public void unsetArcsize()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(ARCSIZE$152);
        }
    }
}
