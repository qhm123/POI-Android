 ...
 * Java type: schemasMicrosoftComVml.CTArc
 *
 * Automatically generated - do not modify.
 */
package schemasMicrosoftComVml.impl;
/**
 * An XML CT_Arc(@urn:schemas-microsoft-com:vml).
 *
 * This is a complex type.
 */
public class CTArcImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements schemasMicrosoftComVml.CTArc
{
    
    public CTArcImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName STARTANGLE$152 = 
        new javax.xml.namespace.QName("", "startAngle");
    private static final javax.xml.namespace.QName ENDANGLE$154 = 
        new javax.xml.namespace.QName("", "endAngle");
    ...
    public java.util.List<schemasMicrosoftComVml.CTPath> getPathList()
    {
        final class PathList extends java.util.AbstractList<schemasMicrosoftComVml.CTPath>
        {
            ...
            {
                schemasMicrosoftComVml.CTPath old = CTArcImpl.this.getPathArray(i);
                CTArcImpl.this.setPathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTPath o)
                { CTArcImpl.this.insertNewPath(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTFormulas> getFormulasList()
    {
        final class FormulasList extends java.util.AbstractList<schemasMicrosoftComVml.CTFormulas>
        {
            ...
            {
                schemasMicrosoftComVml.CTFormulas old = CTArcImpl.this.getFormulasArray(i);
                CTArcImpl.this.setFormulasArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTFormulas o)
                { CTArcImpl.this.insertNewFormulas(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTHandles> getHandlesList()
    {
        final class HandlesList extends java.util.AbstractList<schemasMicrosoftComVml.CTHandles>
        {
            ...
            {
                schemasMicrosoftComVml.CTHandles old = CTArcImpl.this.getHandlesArray(i);
                CTArcImpl.this.setHandlesArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTHandles o)
                { CTArcImpl.this.insertNewHandles(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTFill> getFillList()
    {
        final class FillList extends java.util.AbstractList<schemasMicrosoftComVml.CTFill>
        {
            ...
            {
                schemasMicrosoftComVml.CTFill old = CTArcImpl.this.getFillArray(i);
                CTArcImpl.this.setFillArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTFill o)
                { CTArcImpl.this.insertNewFill(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTStroke> getStrokeList()
    {
        final class StrokeList extends java.util.AbstractList<schemasMicrosoftComVml.CTStroke>
        {
            ...
            {
                schemasMicrosoftComVml.CTStroke old = CTArcImpl.this.getStrokeArray(i);
                CTArcImpl.this.setStrokeArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTStroke o)
                { CTArcImpl.this.insertNewStroke(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTShadow> getShadowList()
    {
        final class ShadowList extends java.util.AbstractList<schemasMicrosoftComVml.CTShadow>
        {
            ...
            {
                schemasMicrosoftComVml.CTShadow old = CTArcImpl.this.getShadowArray(i);
                CTArcImpl.this.setShadowArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTShadow o)
                { CTArcImpl.this.insertNewShadow(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTTextbox> getTextboxList()
    {
        final class TextboxList extends java.util.AbstractList<schemasMicrosoftComVml.CTTextbox>
        {
            ...
            {
                schemasMicrosoftComVml.CTTextbox old = CTArcImpl.this.getTextboxArray(i);
                CTArcImpl.this.setTextboxArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTTextbox o)
                { CTArcImpl.this.insertNewTextbox(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTTextPath> getTextpathList()
    {
        final class TextpathList extends java.util.AbstractList<schemasMicrosoftComVml.CTTextPath>
        {
            ...
            {
                schemasMicrosoftComVml.CTTextPath old = CTArcImpl.this.getTextpathArray(i);
                CTArcImpl.this.setTextpathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTTextPath o)
                { CTArcImpl.this.insertNewTextpath(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComVml.CTImageData> getImagedataList()
    {
        final class ImagedataList extends java.util.AbstractList<schemasMicrosoftComVml.CTImageData>
        {
            ...
            {
                schemasMicrosoftComVml.CTImageData old = CTArcImpl.this.getImagedataArray(i);
                CTArcImpl.this.setImagedataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComVml.CTImageData o)
                { CTArcImpl.this.insertNewImagedata(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTSkew> getSkewList()
    {
        final class SkewList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTSkew>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTSkew old = CTArcImpl.this.getSkewArray(i);
                CTArcImpl.this.setSkewArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTSkew o)
                { CTArcImpl.this.insertNewSkew(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTExtrusion> getExtrusionList()
    {
        final class ExtrusionList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTExtrusion>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTExtrusion old = CTArcImpl.this.getExtrusionArray(i);
                CTArcImpl.this.setExtrusionArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTExtrusion o)
                { CTArcImpl.this.insertNewExtrusion(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTCallout> getCalloutList()
    {
        final class CalloutList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTCallout>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTCallout old = CTArcImpl.this.getCalloutArray(i);
                CTArcImpl.this.setCalloutArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTCallout o)
                { CTArcImpl.this.insertNewCallout(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTLock> getLockList()
    {
        final class LockList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTLock>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTLock old = CTArcImpl.this.getLockArray(i);
                CTArcImpl.this.setLockArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTLock o)
                { CTArcImpl.this.insertNewLock(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTClipPath> getClippathList()
    {
        final class ClippathList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTClipPath>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTClipPath old = CTArcImpl.this.getClippathArray(i);
                CTArcImpl.this.setClippathArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTClipPath o)
                { CTArcImpl.this.insertNewClippath(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeOffice.CTSignatureLine> getSignaturelineList()
    {
        final class SignaturelineList extends java.util.AbstractList<schemasMicrosoftComOfficeOffice.CTSignatureLine>
        {
            ...
            {
                schemasMicrosoftComOfficeOffice.CTSignatureLine old = CTArcImpl.this.getSignaturelineArray(i);
                CTArcImpl.this.setSignaturelineArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeOffice.CTSignatureLine o)
                { CTArcImpl.this.insertNewSignatureline(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTWrap> getWrapList()
    {
        final class WrapList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTWrap>
        {
            ...
            {
                schemasMicrosoftComOfficeWord.CTWrap old = CTArcImpl.this.getWrapArray(i);
                CTArcImpl.this.setWrapArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTWrap o)
                { CTArcImpl.this.insertNewWrap(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTAnchorLock> getAnchorlockList()
    {
        final class AnchorlockList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTAnchorLock>
        {
            ...
            {
                schemasMicrosoftComOfficeWord.CTAnchorLock old = CTArcImpl.this.getAnchorlockArray(i);
                CTArcImpl.this.setAnchorlockArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTAnchorLock o)
                { CTArcImpl.this.insertNewAnchorlock(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBordertopList()
    {
        final class BordertopList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTBorder>
        {
            ...
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTArcImpl.this.getBordertopArray(i);
                CTArcImpl.this.setBordertopArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTArcImpl.this.insertNewBordertop(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderbottomList()
    {
        final class BorderbottomList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTBorder>
        {
            ...
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTArcImpl.this.getBorderbottomArray(i);
                CTArcImpl.this.setBorderbottomArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTArcImpl.this.insertNewBorderbottom(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderleftList()
    {
        final class BorderleftList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTBorder>
        {
            ...
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTArcImpl.this.getBorderleftArray(i);
                CTArcImpl.this.setBorderleftArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTArcImpl.this.insertNewBorderleft(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeWord.CTBorder> getBorderrightList()
    {
        final class BorderrightList extends java.util.AbstractList<schemasMicrosoftComOfficeWord.CTBorder>
        {
            ...
            public schemasMicrosoftComOfficeWord.CTBorder set(int i, schemasMicrosoftComOfficeWord.CTBorder o)
            {
                schemasMicrosoftComOfficeWord.CTBorder old = CTArcImpl.this.getBorderrightArray(i);
                CTArcImpl.this.setBorderrightArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeWord.CTBorder o)
                { CTArcImpl.this.insertNewBorderright(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficeExcel.CTClientData> getClientDataList()
    {
        final class ClientDataList extends java.util.AbstractList<schemasMicrosoftComOfficeExcel.CTClientData>
        {
            ...
            {
                schemasMicrosoftComOfficeExcel.CTClientData old = CTArcImpl.this.getClientDataArray(i);
                CTArcImpl.this.setClientDataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficeExcel.CTClientData o)
                { CTArcImpl.this.insertNewClientData(i).set(o); }
    ...
    public java.util.List<schemasMicrosoftComOfficePowerpoint.CTRel> getTextdataList()
    {
        final class TextdataList extends java.util.AbstractList<schemasMicrosoftComOfficePowerpoint.CTRel>
        {
            ...
            {
                schemasMicrosoftComOfficePowerpoint.CTRel old = CTArcImpl.this.getTextdataArray(i);
                CTArcImpl.this.setTextdataArray(i, o);
                return old;
            }
            
            public void add(int i, schemasMicrosoftComOfficePowerpoint.CTRel o)
                { CTArcImpl.this.insertNewTextdata(i).set(o); }
    ...
    /**
     * Gets the "startAngle" attribute
     */
    public java.math.BigDecimal getStartAngle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(STARTANGLE$152);
            if (target == null)
            {
                return null;
            }
    ...
    /**
     * Gets (as xml) the "startAngle" attribute
     */
    public org.apache.xmlbeans.XmlDecimal xgetStartAngle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlDecimal target = null;
            target = (org.apache.xmlbeans.XmlDecimal)get_store().find_attribute_user(STARTANGLE$152);
            return target;
        }
    }
    
    /**
     * True if has "startAngle" attribute
     */
    public boolean isSetStartAngle()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(STARTANGLE$152) != null;
        }
    }
     ...
     */
    public void setStartAngle(java.math.BigDecimal startAngle)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(STARTANGLE$152);
            }
            target.setBigDecimalValue(startAngle);
        }
    }
    
    /**
     * Sets (as xml) the "startAngle" attribute
     */
    public void xsetStartAngle(org.apache.xmlbeans.XmlDecimal startAngle)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlDecimal)get_store().add_attribute_user(STARTANGLE$152);
            }
    ...
    /**
     * Unsets the "startAngle" attribute
     */
    ...
    /**
     * Gets the "endAngle" attribute
     */
    public java.math.BigDecimal getEndAngle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ENDANGLE$154);
            if (target == null)
            {
                return null;
            }
    ...
    /**
     * Gets (as xml) the "endAngle" attribute
     */
    public org.apache.xmlbeans.XmlDecimal xgetEndAngle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlDecimal target = null;
            target = (org.apache.xmlbeans.XmlDecimal)get_store().find_attribute_user(ENDANGLE$154);
            return target;
        }
    }
    
    /**
     * True if has "endAngle" attribute
     */
    public boolean isSetEndAngle()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(ENDANGLE$154) != null;
        }
    }
    
    /**
     * Sets the "endAngle" attribute
     */
    public void setEndAngle(java.math.BigDecimal endAngle)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ENDANGLE$154);
            }
            target.setBigDecimalValue(endAngle);
        }
    }
    
    /**
     * Sets (as xml) the "endAngle" attribute
     */
    public void xsetEndAngle(org.apache.xmlbeans.XmlDecimal endAngle)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlDecimal)get_store().add_attribute_user(ENDANGLE$154);
            }
            target.set(endAngle);
        }
    }
