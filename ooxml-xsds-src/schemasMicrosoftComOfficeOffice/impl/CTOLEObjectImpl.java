 ...
 * Java type: schemasMicrosoftComOfficeOffice.CTOLEObject
 *
 ...
 */
public class CTOLEObjectImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements schemasMicrosoftComOfficeOffice.CTOLEObject
{
     ...
     */
    public schemasMicrosoftComOfficeOffice.STOLELinkType.Enum getLinkType()
    {
        synchronized (monitor())
        {
            ...
            return (schemasMicrosoftComOfficeOffice.STOLELinkType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public schemasMicrosoftComOfficeOffice.STOLELinkType xgetLinkType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STOLELinkType target = null;
            target = (schemasMicrosoftComOfficeOffice.STOLELinkType)get_store().find_element_user(LINKTYPE$0, 0);
            return target;
        }
    }
     ...
     */
    public void setLinkType(schemasMicrosoftComOfficeOffice.STOLELinkType.Enum linkType)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetLinkType(schemasMicrosoftComOfficeOffice.STOLELinkType linkType)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STOLELinkType)get_store().add_element_user(LINKTYPE$0);
            }
            target.set(linkType);
        }
    }
     ...
     */
    public schemasMicrosoftComOfficeOffice.STTrueFalseBlank.Enum getLockedField()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public schemasMicrosoftComOfficeOffice.STTrueFalseBlank xgetLockedField()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STTrueFalseBlank target = null;
            target = (schemasMicrosoftComOfficeOffice.STTrueFalseBlank)get_store().find_element_user(LOCKEDFIELD$2, 0);
            return target;
        }
    }
     ...
     */
    public void setLockedField(schemasMicrosoftComOfficeOffice.STTrueFalseBlank.Enum lockedField)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetLockedField(schemasMicrosoftComOfficeOffice.STTrueFalseBlank lockedField)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STTrueFalseBlank)get_store().add_element_user(LOCKEDFIELD$2);
            }
     ...
     */
    public schemasMicrosoftComOfficeOffice.STOLEType.Enum getType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (schemasMicrosoftComOfficeOffice.STOLEType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public schemasMicrosoftComOfficeOffice.STOLEType xgetType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STOLEType target = null;
            target = (schemasMicrosoftComOfficeOffice.STOLEType)get_store().find_attribute_user(TYPE$6);
            return target;
        }
    }
     ...
     */
    public void setType(schemasMicrosoftComOfficeOffice.STOLEType.Enum type)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetType(schemasMicrosoftComOfficeOffice.STOLEType type)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STOLEType)get_store().add_attribute_user(TYPE$6);
            }
            target.set(type);
        }
    }
     ...
     */
    public schemasMicrosoftComOfficeOffice.STOLEDrawAspect.Enum getDrawAspect()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (schemasMicrosoftComOfficeOffice.STOLEDrawAspect.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public schemasMicrosoftComOfficeOffice.STOLEDrawAspect xgetDrawAspect()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STOLEDrawAspect target = null;
            target = (schemasMicrosoftComOfficeOffice.STOLEDrawAspect)get_store().find_attribute_user(DRAWASPECT$12);
            return target;
        }
    }
     ...
     */
    public void setDrawAspect(schemasMicrosoftComOfficeOffice.STOLEDrawAspect.Enum drawAspect)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetDrawAspect(schemasMicrosoftComOfficeOffice.STOLEDrawAspect drawAspect)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STOLEDrawAspect)get_store().add_attribute_user(DRAWASPECT$12);
            }
     ...
     */
    public schemasMicrosoftComOfficeOffice.STOLEUpdateMode.Enum getUpdateMode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (schemasMicrosoftComOfficeOffice.STOLEUpdateMode.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public schemasMicrosoftComOfficeOffice.STOLEUpdateMode xgetUpdateMode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            schemasMicrosoftComOfficeOffice.STOLEUpdateMode target = null;
            target = (schemasMicrosoftComOfficeOffice.STOLEUpdateMode)get_store().find_attribute_user(UPDATEMODE$18);
            return target;
        }
    }
     ...
     */
    public void setUpdateMode(schemasMicrosoftComOfficeOffice.STOLEUpdateMode.Enum updateMode)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetUpdateMode(schemasMicrosoftComOfficeOffice.STOLEUpdateMode updateMode)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (schemasMicrosoftComOfficeOffice.STOLEUpdateMode)get_store().add_attribute_user(UPDATEMODE$18);
            }
