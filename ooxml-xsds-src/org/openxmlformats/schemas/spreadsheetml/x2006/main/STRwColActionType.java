...
public interface STRwColActionType extends org.apache.xmlbeans.XmlString
{
    public static final org.apache.xmlbeans.SchemaType type = (org.apache.xmlbeans.SchemaType)
        org.apache.xmlbeans.XmlBeans.typeSystemForClassLoader(STRwColActionType.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("strwcolactiontypeff9atype");
    
    org.apache.xmlbeans.StringEnumAbstractBase enumValue();
    void set(org.apache.xmlbeans.StringEnumAbstractBase e);
    
    static final Enum INSERT_ROW = Enum.forString("insertRow");
    static final Enum DELETE_ROW = Enum.forString("deleteRow");
    static final Enum INSERT_COL = Enum.forString("insertCol");
    static final Enum DELETE_COL = Enum.forString("deleteCol");
    
    static final int INT_INSERT_ROW = Enum.INT_INSERT_ROW;
    static final int INT_DELETE_ROW = Enum.INT_DELETE_ROW;
    static final int INT_INSERT_COL = Enum.INT_INSERT_COL;
    static final int INT_DELETE_COL = Enum.INT_DELETE_COL;
