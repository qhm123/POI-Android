...
public class CTExtensionListImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtensionList
{
    ...
    private static final javax.xml.namespace.QName EXT$0 = 
        new javax.xml.namespace.QName("http://schemas.openxmlformats.org/spreadsheetml/2006/main", "ext");
    ...
    {
        final class ExtList extends java.util.AbstractList<org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension>
        {
            public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension get(int i)
                { return CTExtensionListImpl.this.getExtArray(i); }
            
            public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension set(int i, org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension o)
            {
                org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension old = CTExtensionListImpl.this.getExtArray(i);
                CTExtensionListImpl.this.setExtArray(i, o);
                return old;
            }
            
            public void add(int i, org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension o)
                { CTExtensionListImpl.this.insertNewExt(i).set(o); }
            
            public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension remove(int i)
            {
                org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension old = CTExtensionListImpl.this.getExtArray(i);
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension[] getExtArray()
    {
        synchronized (monitor())
        {
            ...
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension[] result = new org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension[targetList.size()];
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension getExtArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension)get_store().find_element_user(EXT$0, i);
            if (target == null)
            {
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension insertNewExt(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension)get_store().insert_element_user(EXT$0, i);
            return target;
        }
    }
    ...
    public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension addNewExt()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension target = null;
            target = (org.openxmlformats.schemas.spreadsheetml.x2006.main.CTExtension)get_store().add_element_user(EXT$0);
            return target;
        }
    }
