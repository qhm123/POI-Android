...
public class CTNumberImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.spreadsheetml.x2006.main.CTNumber
{
    ...
    public java.util.List<org.openxmlformats.schemas.spreadsheetml.x2006.main.CTTuples> getTplsList()
    {
        final class TplsList extends java.util.AbstractList<org.openxmlformats.schemas.spreadsheetml.x2006.main.CTTuples>
        {
            public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTTuples get(int i)
                { return CTNumberImpl.this.getTplsArray(i); }
            ...
            {
                org.openxmlformats.schemas.spreadsheetml.x2006.main.CTTuples old = CTNumberImpl.this.getTplsArray(i);
                CTNumberImpl.this.setTplsArray(i, o);
                return old;
            }
            
            public void add(int i, org.openxmlformats.schemas.spreadsheetml.x2006.main.CTTuples o)
                { CTNumberImpl.this.insertNewTpls(i).set(o); }
            
            public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTTuples remove(int i)
            {
                org.openxmlformats.schemas.spreadsheetml.x2006.main.CTTuples old = CTNumberImpl.this.getTplsArray(i);
                CTNumberImpl.this.removeTpls(i);
                return old;
            }
            
            public int size()
                { return CTNumberImpl.this.sizeOfTplsArray(); }
    ...
    public java.util.List<org.openxmlformats.schemas.spreadsheetml.x2006.main.CTX> getXList()
    {
        final class XList extends java.util.AbstractList<org.openxmlformats.schemas.spreadsheetml.x2006.main.CTX>
        {
            public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTX get(int i)
                { return CTNumberImpl.this.getXArray(i); }
            ...
            {
                org.openxmlformats.schemas.spreadsheetml.x2006.main.CTX old = CTNumberImpl.this.getXArray(i);
                CTNumberImpl.this.setXArray(i, o);
                return old;
            }
            
            public void add(int i, org.openxmlformats.schemas.spreadsheetml.x2006.main.CTX o)
                { CTNumberImpl.this.insertNewX(i).set(o); }
            
            public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTX remove(int i)
            {
                org.openxmlformats.schemas.spreadsheetml.x2006.main.CTX old = CTNumberImpl.this.getXArray(i);
                CTNumberImpl.this.removeX(i);
                return old;
            }
            
            public int size()
                { return CTNumberImpl.this.sizeOfXArray(); }
    ...
    public org.apache.xmlbeans.XmlDouble xgetV()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlDouble)get_store().find_attribute_user(V$4);
            return target;
        }
    }
    ...
    public void xsetV(org.apache.xmlbeans.XmlDouble v)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlDouble)get_store().add_attribute_user(V$4);
            }
            target.set(v);
        }
    }
