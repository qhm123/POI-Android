 ...
 */
public class CTColFieldsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.spreadsheetml.x2006.main.CTColFields
{
    
    public CTColFieldsImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public java.util.List<org.openxmlformats.schemas.spreadsheetml.x2006.main.CTField> getFieldList()
    {
        final class FieldList extends java.util.AbstractList<org.openxmlformats.schemas.spreadsheetml.x2006.main.CTField>
        {
            public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTField get(int i)
                { return CTColFieldsImpl.this.getFieldArray(i); }
            ...
            {
                org.openxmlformats.schemas.spreadsheetml.x2006.main.CTField old = CTColFieldsImpl.this.getFieldArray(i);
                CTColFieldsImpl.this.setFieldArray(i, o);
                return old;
            }
            
            public void add(int i, org.openxmlformats.schemas.spreadsheetml.x2006.main.CTField o)
                { CTColFieldsImpl.this.insertNewField(i).set(o); }
            
            public org.openxmlformats.schemas.spreadsheetml.x2006.main.CTField remove(int i)
            {
                org.openxmlformats.schemas.spreadsheetml.x2006.main.CTField old = CTColFieldsImpl.this.getFieldArray(i);
                CTColFieldsImpl.this.removeField(i);
                return old;
            }
            
            public int size()
                { return CTColFieldsImpl.this.sizeOfFieldArray(); }
