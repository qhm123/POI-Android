...
public class CTDateTimeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.spreadsheetml.x2006.main.CTDateTime
{
    ...
    public java.util.List<org.openxmlformats.schemas.spreadsheetml.x2006.main.CTX> getXList()
    {
        final class XList extends java.util.AbstractList<org.openxmlformats.schemas.spreadsheetml.x2006.main.CTX>
        {
            ...
            {
                org.openxmlformats.schemas.spreadsheetml.x2006.main.CTX old = CTDateTimeImpl.this.getXArray(i);
                CTDateTimeImpl.this.setXArray(i, o);
                return old;
            }
            
            public void add(int i, org.openxmlformats.schemas.spreadsheetml.x2006.main.CTX o)
                { CTDateTimeImpl.this.insertNewX(i).set(o); }
    ...
    public org.apache.xmlbeans.XmlDateTime xgetV()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlDateTime)get_store().find_attribute_user(V$2);
            return target;
        }
    }
    ...
    public void xsetV(org.apache.xmlbeans.XmlDateTime v)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlDateTime)get_store().add_attribute_user(V$2);
            }
            target.set(v);
        }
    }
