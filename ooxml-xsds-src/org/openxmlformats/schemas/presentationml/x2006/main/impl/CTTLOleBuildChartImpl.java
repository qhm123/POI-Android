...
public class CTTLOleBuildChartImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.presentationml.x2006.main.CTTLOleBuildChart
{
    ...
    private static final javax.xml.namespace.QName ANIMBG$8 = 
    ...
    public org.openxmlformats.schemas.presentationml.x2006.main.STTLOleChartBuildType.Enum getBld()
    {
        synchronized (monitor())
        {
            ...
            return (org.openxmlformats.schemas.presentationml.x2006.main.STTLOleChartBuildType.Enum)target.getEnumValue();
        }
    }
    ...
    public org.openxmlformats.schemas.presentationml.x2006.main.STTLOleChartBuildType xgetBld()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openxmlformats.schemas.presentationml.x2006.main.STTLOleChartBuildType)get_store().find_attribute_user(BLD$6);
            if (target == null)
            {
                target = (org.openxmlformats.schemas.presentationml.x2006.main.STTLOleChartBuildType)get_default_attribute_value(BLD$6);
            }
            return target;
        }
    }
    ...
    public void xsetBld(org.openxmlformats.schemas.presentationml.x2006.main.STTLOleChartBuildType bld)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.presentationml.x2006.main.STTLOleChartBuildType)get_store().add_attribute_user(BLD$6);
            }
            target.set(bld);
        }
    }
    ...
    public boolean getAnimBg()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(ANIMBG$8);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(ANIMBG$8);
            }
            if (target == null)
            {
                return false;
    ...
    public org.apache.xmlbeans.XmlBoolean xgetAnimBg()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.XmlBoolean target = null;
            target = (org.apache.xmlbeans.XmlBoolean)get_store().find_attribute_user(ANIMBG$8);
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_default_attribute_value(ANIMBG$8);
            }
            return target;
        }
    }
    ...
    public boolean isSetAnimBg()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(ANIMBG$8) != null;
        }
    }
    ...
    public void setAnimBg(boolean animBg)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(ANIMBG$8);
            }
    ...
    public void xsetAnimBg(org.apache.xmlbeans.XmlBoolean animBg)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlBoolean)get_store().add_attribute_user(ANIMBG$8);
            }
            target.set(animBg);
        }
    }
