...
public interface STTLTimeNodePresetClassType extends org.apache.xmlbeans.XmlToken
{
    public static final org.apache.xmlbeans.SchemaType type = (org.apache.xmlbeans.SchemaType)
        org.apache.xmlbeans.XmlBeans.typeSystemForClassLoader(STTLTimeNodePresetClassType.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("sttltimenodepresetclasstypef353type");
    
    org.apache.xmlbeans.StringEnumAbstractBase enumValue();
    void set(org.apache.xmlbeans.StringEnumAbstractBase e);
    
    static final Enum ENTR = Enum.forString("entr");
    static final Enum EXIT = Enum.forString("exit");
    static final Enum EMPH = Enum.forString("emph");
    static final Enum PATH = Enum.forString("path");
    static final Enum VERB = Enum.forString("verb");
    static final Enum MEDIACALL = Enum.forString("mediacall");
    
    static final int INT_ENTR = Enum.INT_ENTR;
    static final int INT_EXIT = Enum.INT_EXIT;
    static final int INT_EMPH = Enum.INT_EMPH;
    static final int INT_PATH = Enum.INT_PATH;
    static final int INT_VERB = Enum.INT_VERB;
    static final int INT_MEDIACALL = Enum.INT_MEDIACALL;
