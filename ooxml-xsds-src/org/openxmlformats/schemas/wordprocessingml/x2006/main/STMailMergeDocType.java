...
public interface STMailMergeDocType extends org.apache.xmlbeans.XmlString
{
    public static final org.apache.xmlbeans.SchemaType type = (org.apache.xmlbeans.SchemaType)
        org.apache.xmlbeans.XmlBeans.typeSystemForClassLoader(STMailMergeDocType.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("stmailmergedoctype4be7type");
    
    org.apache.xmlbeans.StringEnumAbstractBase enumValue();
    void set(org.apache.xmlbeans.StringEnumAbstractBase e);
    
    static final Enum CATALOG = Enum.forString("catalog");
    static final Enum ENVELOPES = Enum.forString("envelopes");
    static final Enum MAILING_LABELS = Enum.forString("mailingLabels");
    static final Enum FORM_LETTERS = Enum.forString("formLetters");
    static final Enum EMAIL = Enum.forString("email");
    static final Enum FAX = Enum.forString("fax");
    
    static final int INT_CATALOG = Enum.INT_CATALOG;
    static final int INT_ENVELOPES = Enum.INT_ENVELOPES;
    static final int INT_MAILING_LABELS = Enum.INT_MAILING_LABELS;
    static final int INT_FORM_LETTERS = Enum.INT_FORM_LETTERS;
