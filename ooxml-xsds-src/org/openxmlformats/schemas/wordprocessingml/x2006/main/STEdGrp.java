...
public interface STEdGrp extends org.apache.xmlbeans.XmlString
{
    public static final org.apache.xmlbeans.SchemaType type = (org.apache.xmlbeans.SchemaType)
        org.apache.xmlbeans.XmlBeans.typeSystemForClassLoader(STEdGrp.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("stedgrp6bdctype");
    
    org.apache.xmlbeans.StringEnumAbstractBase enumValue();
    void set(org.apache.xmlbeans.StringEnumAbstractBase e);
    
    static final Enum NONE = Enum.forString("none");
    static final Enum EVERYONE = Enum.forString("everyone");
    static final Enum ADMINISTRATORS = Enum.forString("administrators");
    static final Enum CONTRIBUTORS = Enum.forString("contributors");
    static final Enum EDITORS = Enum.forString("editors");
    static final Enum OWNERS = Enum.forString("owners");
    static final Enum CURRENT = Enum.forString("current");
    
    static final int INT_NONE = Enum.INT_NONE;
    static final int INT_EVERYONE = Enum.INT_EVERYONE;
    static final int INT_ADMINISTRATORS = Enum.INT_ADMINISTRATORS;
    static final int INT_CONTRIBUTORS = Enum.INT_CONTRIBUTORS;
    static final int INT_EDITORS = Enum.INT_EDITORS;
    static final int INT_OWNERS = Enum.INT_OWNERS;
