...
public interface STMultiLevelType extends org.apache.xmlbeans.XmlString
{
    public static final org.apache.xmlbeans.SchemaType type = (org.apache.xmlbeans.SchemaType)
        org.apache.xmlbeans.XmlBeans.typeSystemForClassLoader(STMultiLevelType.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("stmultileveltypebc13type");
    
    org.apache.xmlbeans.StringEnumAbstractBase enumValue();
    void set(org.apache.xmlbeans.StringEnumAbstractBase e);
    
    static final Enum SINGLE_LEVEL = Enum.forString("singleLevel");
    static final Enum MULTILEVEL = Enum.forString("multilevel");
    static final Enum HYBRID_MULTILEVEL = Enum.forString("hybridMultilevel");
    
    static final int INT_SINGLE_LEVEL = Enum.INT_SINGLE_LEVEL;
    static final int INT_MULTILEVEL = Enum.INT_MULTILEVEL;
    static final int INT_HYBRID_MULTILEVEL = Enum.INT_HYBRID_MULTILEVEL;
