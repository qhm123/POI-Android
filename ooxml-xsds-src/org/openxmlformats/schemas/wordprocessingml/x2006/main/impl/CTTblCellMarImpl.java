/*
 * XML Type:  CT_TblCellMar
 * Namespace: http://schemas.openxmlformats.org/wordprocessingml/2006/main
 * Java type: org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblCellMar
 *
 ...
 */
public class CTTblCellMarImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblCellMar
{
    
    public CTTblCellMarImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth getTop()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth)get_store().find_element_user(TOP$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setTop(org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth top)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth)get_store().add_element_user(TOP$0);
            }
            target.set(top);
        }
    }
    ...
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth getLeft()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth target = null;
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth)get_store().find_element_user(LEFT$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setLeft(org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth left)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth)get_store().add_element_user(LEFT$2);
            }
            target.set(left);
        }
    }
    ...
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth getBottom()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth target = null;
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth)get_store().find_element_user(BOTTOM$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setBottom(org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth bottom)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth)get_store().add_element_user(BOTTOM$4);
            }
            target.set(bottom);
        }
    }
    ...
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth getRight()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth target = null;
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth)get_store().find_element_user(RIGHT$6, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setRight(org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth right)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth)get_store().add_element_user(RIGHT$6);
            }
            target.set(right);
        }
    }
