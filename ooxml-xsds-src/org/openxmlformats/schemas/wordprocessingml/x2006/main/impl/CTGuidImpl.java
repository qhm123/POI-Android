...
public class CTGuidImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.wordprocessingml.x2006.main.CTGuid
{
     ...
     */
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.STGuid xgetVal()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.wordprocessingml.x2006.main.STGuid target = null;
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.STGuid)get_store().find_attribute_user(VAL$0);
            return target;
        }
    }
     ...
     */
    public void xsetVal(org.openxmlformats.schemas.wordprocessingml.x2006.main.STGuid val)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.STGuid)get_store().add_attribute_user(VAL$0);
            }
            target.set(val);
        }
    }
