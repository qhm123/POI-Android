 ...
 */
public class CTSdtRowImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtRow
{
    
    public CTSdtRowImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRow getSdtContent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRow target = null;
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRow)get_store().find_element_user(SDTCONTENT$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSdtContent(org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRow sdtContent)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRow)get_store().add_element_user(SDTCONTENT$4);
            }
     ...
     */
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRow addNewSdtContent()
    {
        synchronized (monitor())
        {
            check_orphaned();
