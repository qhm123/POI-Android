 ...
 */
public class CTAutoCaptionImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.wordprocessingml.x2006.main.CTAutoCaption
{
    
    public CTAutoCaptionImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.STString xgetCaption()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.wordprocessingml.x2006.main.STString target = null;
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.STString)get_store().find_attribute_user(CAPTION$2);
            return target;
        }
    }
     ...
     */
    public void xsetCaption(org.openxmlformats.schemas.wordprocessingml.x2006.main.STString caption)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.STString)get_store().add_attribute_user(CAPTION$2);
            }
            target.set(caption);
        }
    }
