 ...
 */
public class CTFFStatusTextImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.wordprocessingml.x2006.main.CTFFStatusText
{
    
    public CTFFStatusTextImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.STFFStatusTextVal xgetVal()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.wordprocessingml.x2006.main.STFFStatusTextVal target = null;
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.STFFStatusTextVal)get_store().find_attribute_user(VAL$2);
            return target;
        }
    }
     ...
     */
    public void xsetVal(org.openxmlformats.schemas.wordprocessingml.x2006.main.STFFStatusTextVal val)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.STFFStatusTextVal)get_store().add_attribute_user(VAL$2);
            }
            target.set(val);
        }
    }
