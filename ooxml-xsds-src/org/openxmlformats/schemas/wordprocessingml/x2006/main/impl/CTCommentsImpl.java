...
public class CTCommentsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComments
{
    ...
    private static final javax.xml.namespace.QName COMMENT$0 = 
        new javax.xml.namespace.QName("http://schemas.openxmlformats.org/wordprocessingml/2006/main", "comment");
    ...
    {
        final class CommentList extends java.util.AbstractList<org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment>
        {
            public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment get(int i)
                { return CTCommentsImpl.this.getCommentArray(i); }
            
            public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment set(int i, org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment o)
            {
                org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment old = CTCommentsImpl.this.getCommentArray(i);
                CTCommentsImpl.this.setCommentArray(i, o);
                return old;
            }
            
            public void add(int i, org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment o)
                { CTCommentsImpl.this.insertNewComment(i).set(o); }
            
            public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment remove(int i)
            {
                org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment old = CTCommentsImpl.this.getCommentArray(i);
    ...
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment[] getCommentArray()
    {
        synchronized (monitor())
        {
            ...
            org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment[] result = new org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment[targetList.size()];
    ...
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment getCommentArray(int i)
    {
        synchronized (monitor())
        {
            ...
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment)get_store().find_element_user(COMMENT$0, i);
            if (target == null)
            {
    ...
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment insertNewComment(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment target = null;
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment)get_store().insert_element_user(COMMENT$0, i);
            return target;
        }
    }
    ...
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment addNewComment()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment target = null;
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTComment)get_store().add_element_user(COMMENT$0);
            return target;
        }
    }
