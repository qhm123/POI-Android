...
public class CTDocTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.wordprocessingml.x2006.main.CTDocType
{
     ...
     */
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.STDocType.Enum getVal()
    {
        synchronized (monitor())
        {
            ...
            return (org.openxmlformats.schemas.wordprocessingml.x2006.main.STDocType.Enum)target.getEnumValue();
        }
    }
    ...
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.STDocType xgetVal()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.STDocType)get_store().find_attribute_user(VAL$0);
            return target;
        }
    }
     ...
     */
    public void setVal(org.openxmlformats.schemas.wordprocessingml.x2006.main.STDocType.Enum val)
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void xsetVal(org.openxmlformats.schemas.wordprocessingml.x2006.main.STDocType val)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.STDocType)get_store().add_attribute_user(VAL$0);
            }
            target.set(val);
        }
    }
