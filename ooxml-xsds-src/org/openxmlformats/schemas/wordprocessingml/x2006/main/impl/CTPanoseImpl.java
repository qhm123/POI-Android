...
public class CTPanoseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.wordprocessingml.x2006.main.CTPanose
{
     ...
     */
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.STPanose xgetVal()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.wordprocessingml.x2006.main.STPanose target = null;
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.STPanose)get_store().find_attribute_user(VAL$0);
            return target;
        }
    }
     ...
     */
    public void xsetVal(org.openxmlformats.schemas.wordprocessingml.x2006.main.STPanose val)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.STPanose)get_store().add_attribute_user(VAL$0);
            }
            target.set(val);
        }
    }
