 ...
 */
public class CTSdtRunImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtRun
{
    
    public CTSdtRunImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRun getSdtContent()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRun target = null;
            target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRun)get_store().find_element_user(SDTCONTENT$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSdtContent(org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRun sdtContent)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRun)get_store().add_element_user(SDTCONTENT$4);
            }
     ...
     */
    public org.openxmlformats.schemas.wordprocessingml.x2006.main.CTSdtContentRun addNewSdtContent()
    {
        synchronized (monitor())
        {
            check_orphaned();
