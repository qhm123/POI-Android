/*
 * XML Type:  CT_AreaChart
 * Namespace: http://schemas.openxmlformats.org/drawingml/2006/chart
 * Java type: org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaChart
 *
 * Automatically generated - do not modify.
 */
package org.openxmlformats.schemas.drawingml.x2006.chart.impl;
/**
 * An XML CT_AreaChart(@http://schemas.openxmlformats.org/drawingml/2006/chart).
 *
 * This is a complex type.
 */
public class CTAreaChartImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaChart
{
    
    public CTAreaChartImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    public java.util.List<org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaSer> getSerList()
    {
        final class SerList extends java.util.AbstractList<org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaSer>
        {
            public org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaSer get(int i)
                { return CTAreaChartImpl.this.getSerArray(i); }
            ...
            {
                org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaSer old = CTAreaChartImpl.this.getSerArray(i);
                CTAreaChartImpl.this.setSerArray(i, o);
                return old;
            }
            
            public void add(int i, org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaSer o)
                { CTAreaChartImpl.this.insertNewSer(i).set(o); }
            
            public org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaSer remove(int i)
            {
                org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaSer old = CTAreaChartImpl.this.getSerArray(i);
                CTAreaChartImpl.this.removeSer(i);
                return old;
            }
    ...
    public java.util.List<org.openxmlformats.schemas.drawingml.x2006.chart.CTUnsignedInt> getAxIdList()
    {
        final class AxIdList extends java.util.AbstractList<org.openxmlformats.schemas.drawingml.x2006.chart.CTUnsignedInt>
        {
            public org.openxmlformats.schemas.drawingml.x2006.chart.CTUnsignedInt get(int i)
                { return CTAreaChartImpl.this.getAxIdArray(i); }
            ...
            {
                org.openxmlformats.schemas.drawingml.x2006.chart.CTUnsignedInt old = CTAreaChartImpl.this.getAxIdArray(i);
                CTAreaChartImpl.this.setAxIdArray(i, o);
                return old;
            }
            
            public void add(int i, org.openxmlformats.schemas.drawingml.x2006.chart.CTUnsignedInt o)
                { CTAreaChartImpl.this.insertNewAxId(i).set(o); }
            
            public org.openxmlformats.schemas.drawingml.x2006.chart.CTUnsignedInt remove(int i)
            {
                org.openxmlformats.schemas.drawingml.x2006.chart.CTUnsignedInt old = CTAreaChartImpl.this.getAxIdArray(i);
                CTAreaChartImpl.this.removeAxId(i);
                return old;
            }
