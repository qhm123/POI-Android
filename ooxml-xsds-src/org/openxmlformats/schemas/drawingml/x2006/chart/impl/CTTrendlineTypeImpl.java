...
public class CTTrendlineTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.chart.CTTrendlineType
{
    ...
    public org.openxmlformats.schemas.drawingml.x2006.chart.STTrendlineType.Enum getVal()
    {
        synchronized (monitor())
        {
            ...
            return (org.openxmlformats.schemas.drawingml.x2006.chart.STTrendlineType.Enum)target.getEnumValue();
        }
    }
    ...
    public org.openxmlformats.schemas.drawingml.x2006.chart.STTrendlineType xgetVal()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.chart.STTrendlineType)get_store().find_attribute_user(VAL$0);
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.chart.STTrendlineType)get_default_attribute_value(VAL$0);
            }
            return target;
        }
    }
    ...
    public void xsetVal(org.openxmlformats.schemas.drawingml.x2006.chart.STTrendlineType val)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.chart.STTrendlineType)get_store().add_attribute_user(VAL$0);
            }
            target.set(val);
        }
    }
