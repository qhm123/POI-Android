...
public class CTRotYImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.chart.CTRotY
{
    ...
    public org.openxmlformats.schemas.drawingml.x2006.chart.STRotY xgetVal()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.chart.STRotY)get_store().find_attribute_user(VAL$0);
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.chart.STRotY)get_default_attribute_value(VAL$0);
            }
            return target;
        }
    }
    ...
    public void xsetVal(org.openxmlformats.schemas.drawingml.x2006.chart.STRotY val)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.chart.STRotY)get_store().add_attribute_user(VAL$0);
            }
            target.set(val);
        }
    }
