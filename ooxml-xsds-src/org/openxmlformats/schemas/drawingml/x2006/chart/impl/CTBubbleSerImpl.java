 ...
 */
public class CTBubbleSerImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.chart.CTBubbleSer
{
    
    public CTBubbleSerImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName BUBBLESIZE$22 = 
        new javax.xml.namespace.QName("http://schemas.openxmlformats.org/drawingml/2006/chart", "bubbleSize");
    private static final javax.xml.namespace.QName BUBBLE3D$24 = 
    ...
    public java.util.List<org.openxmlformats.schemas.drawingml.x2006.chart.CTDPt> getDPtList()
    {
        final class DPtList extends java.util.AbstractList<org.openxmlformats.schemas.drawingml.x2006.chart.CTDPt>
        {
            public org.openxmlformats.schemas.drawingml.x2006.chart.CTDPt get(int i)
                { return CTBubbleSerImpl.this.getDPtArray(i); }
            ...
            {
                org.openxmlformats.schemas.drawingml.x2006.chart.CTDPt old = CTBubbleSerImpl.this.getDPtArray(i);
                CTBubbleSerImpl.this.setDPtArray(i, o);
                return old;
            }
            
            public void add(int i, org.openxmlformats.schemas.drawingml.x2006.chart.CTDPt o)
                { CTBubbleSerImpl.this.insertNewDPt(i).set(o); }
            
            public org.openxmlformats.schemas.drawingml.x2006.chart.CTDPt remove(int i)
            {
                org.openxmlformats.schemas.drawingml.x2006.chart.CTDPt old = CTBubbleSerImpl.this.getDPtArray(i);
                CTBubbleSerImpl.this.removeDPt(i);
                return old;
            }
            
            public int size()
                { return CTBubbleSerImpl.this.sizeOfDPtArray(); }
    ...
    public java.util.List<org.openxmlformats.schemas.drawingml.x2006.chart.CTTrendline> getTrendlineList()
    {
        final class TrendlineList extends java.util.AbstractList<org.openxmlformats.schemas.drawingml.x2006.chart.CTTrendline>
        {
            public org.openxmlformats.schemas.drawingml.x2006.chart.CTTrendline get(int i)
                { return CTBubbleSerImpl.this.getTrendlineArray(i); }
            ...
            {
                org.openxmlformats.schemas.drawingml.x2006.chart.CTTrendline old = CTBubbleSerImpl.this.getTrendlineArray(i);
                CTBubbleSerImpl.this.setTrendlineArray(i, o);
                return old;
            }
            
            public void add(int i, org.openxmlformats.schemas.drawingml.x2006.chart.CTTrendline o)
                { CTBubbleSerImpl.this.insertNewTrendline(i).set(o); }
            
            public org.openxmlformats.schemas.drawingml.x2006.chart.CTTrendline remove(int i)
            {
                org.openxmlformats.schemas.drawingml.x2006.chart.CTTrendline old = CTBubbleSerImpl.this.getTrendlineArray(i);
                CTBubbleSerImpl.this.removeTrendline(i);
                return old;
            }
            
            public int size()
                { return CTBubbleSerImpl.this.sizeOfTrendlineArray(); }
    ...
    public java.util.List<org.openxmlformats.schemas.drawingml.x2006.chart.CTErrBars> getErrBarsList()
    {
        final class ErrBarsList extends java.util.AbstractList<org.openxmlformats.schemas.drawingml.x2006.chart.CTErrBars>
        {
            public org.openxmlformats.schemas.drawingml.x2006.chart.CTErrBars get(int i)
                { return CTBubbleSerImpl.this.getErrBarsArray(i); }
            ...
            {
                org.openxmlformats.schemas.drawingml.x2006.chart.CTErrBars old = CTBubbleSerImpl.this.getErrBarsArray(i);
                CTBubbleSerImpl.this.setErrBarsArray(i, o);
                return old;
            }
            
            public void add(int i, org.openxmlformats.schemas.drawingml.x2006.chart.CTErrBars o)
                { CTBubbleSerImpl.this.insertNewErrBars(i).set(o); }
            
            public org.openxmlformats.schemas.drawingml.x2006.chart.CTErrBars remove(int i)
            {
                org.openxmlformats.schemas.drawingml.x2006.chart.CTErrBars old = CTBubbleSerImpl.this.getErrBarsArray(i);
                CTBubbleSerImpl.this.removeErrBars(i);
                return old;
            }
            
            public int size()
                { return CTBubbleSerImpl.this.sizeOfErrBarsArray(); }
     ...
     */
    public org.openxmlformats.schemas.drawingml.x2006.chart.CTNumDataSource getBubbleSize()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.drawingml.x2006.chart.CTNumDataSource target = null;
            target = (org.openxmlformats.schemas.drawingml.x2006.chart.CTNumDataSource)get_store().find_element_user(BUBBLESIZE$22, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetBubbleSize()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(BUBBLESIZE$22) != 0;
        }
    }
     ...
     */
    public void setBubbleSize(org.openxmlformats.schemas.drawingml.x2006.chart.CTNumDataSource bubbleSize)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.chart.CTNumDataSource)get_store().add_element_user(BUBBLESIZE$22);
            }
            target.set(bubbleSize);
        }
    }
     ...
     */
    public org.openxmlformats.schemas.drawingml.x2006.chart.CTNumDataSource addNewBubbleSize()
    {
        synchronized (monitor())
        {
            check_orphaned();
    ...
    public void unsetBubbleSize()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(BUBBLESIZE$22, 0);
        }
    }
    ...
    public org.openxmlformats.schemas.drawingml.x2006.chart.CTBoolean getBubble3D()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.drawingml.x2006.chart.CTBoolean target = null;
            target = (org.openxmlformats.schemas.drawingml.x2006.chart.CTBoolean)get_store().find_element_user(BUBBLE3D$24, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetBubble3D()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(BUBBLE3D$24) != 0;
        }
    }
    ...
    public void setBubble3D(org.openxmlformats.schemas.drawingml.x2006.chart.CTBoolean bubble3D)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.chart.CTBoolean)get_store().add_element_user(BUBBLE3D$24);
            }
            target.set(bubble3D);
        }
    }
    ...
    public void unsetBubble3D()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(BUBBLE3D$24, 0);
        }
    }
