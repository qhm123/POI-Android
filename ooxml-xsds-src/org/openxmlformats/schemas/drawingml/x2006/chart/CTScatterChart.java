 ...
 */
public interface CTScatterChart extends org.apache.xmlbeans.XmlObject
{
    public static final org.apache.xmlbeans.SchemaType type = (org.apache.xmlbeans.SchemaType)
        org.apache.xmlbeans.XmlBeans.typeSystemForClassLoader(CTScatterChart.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("ctscatterchart2bfctype");
    
    /**
     * Gets the "scatterStyle" element
     */
    org.openxmlformats.schemas.drawingml.x2006.chart.CTScatterStyle getScatterStyle();
    
    /**
     * Sets the "scatterStyle" element
     */
    void setScatterStyle(org.openxmlformats.schemas.drawingml.x2006.chart.CTScatterStyle scatterStyle);
    
    /**
     * Appends and returns a new empty "scatterStyle" element
     */
    org.openxmlformats.schemas.drawingml.x2006.chart.CTScatterStyle addNewScatterStyle();
     ...
     */
    java.util.List<org.openxmlformats.schemas.drawingml.x2006.chart.CTScatterSer> getSerList();
    
    /**
     * Gets array of all "ser" elements
     * @deprecated
     */
    org.openxmlformats.schemas.drawingml.x2006.chart.CTScatterSer[] getSerArray();
    
    /**
     * Gets ith "ser" element
     */
    org.openxmlformats.schemas.drawingml.x2006.chart.CTScatterSer getSerArray(int i);
     ...
     */
    void setSerArray(org.openxmlformats.schemas.drawingml.x2006.chart.CTScatterSer[] serArray);
    
    /**
     * Sets ith "ser" element
     */
    void setSerArray(int i, org.openxmlformats.schemas.drawingml.x2006.chart.CTScatterSer ser);
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "ser" element
     */
    org.openxmlformats.schemas.drawingml.x2006.chart.CTScatterSer insertNewSer(int i);
