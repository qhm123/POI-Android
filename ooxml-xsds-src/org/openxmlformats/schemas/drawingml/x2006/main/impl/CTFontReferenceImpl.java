 ...
 */
public class CTFontReferenceImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.main.CTFontReference
{
    
    public CTFontReferenceImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName IDX$12 = 
     ...
     */
    public org.openxmlformats.schemas.drawingml.x2006.main.STFontCollectionIndex.Enum getIdx()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(IDX$12);
            if (target == null)
            {
                return null;
            }
            return (org.openxmlformats.schemas.drawingml.x2006.main.STFontCollectionIndex.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public org.openxmlformats.schemas.drawingml.x2006.main.STFontCollectionIndex xgetIdx()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.drawingml.x2006.main.STFontCollectionIndex target = null;
            target = (org.openxmlformats.schemas.drawingml.x2006.main.STFontCollectionIndex)get_store().find_attribute_user(IDX$12);
            return target;
        }
    }
     ...
     */
    public void setIdx(org.openxmlformats.schemas.drawingml.x2006.main.STFontCollectionIndex.Enum idx)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(IDX$12);
            }
     ...
     */
    public void xsetIdx(org.openxmlformats.schemas.drawingml.x2006.main.STFontCollectionIndex idx)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.main.STFontCollectionIndex)get_store().add_attribute_user(IDX$12);
            }
            target.set(idx);
        }
    }
