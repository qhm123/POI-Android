 ...
 */
public class CTGlowEffectImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.main.CTGlowEffect
{
    
    public CTGlowEffectImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName RAD$12 = 
    ...
    public long getRad()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(RAD$12);
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_default_attribute_value(RAD$12);
            }
            if (target == null)
            {
                return 0L;
    ...
    public org.openxmlformats.schemas.drawingml.x2006.main.STPositiveCoordinate xgetRad()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.main.STPositiveCoordinate)get_store().find_attribute_user(RAD$12);
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.main.STPositiveCoordinate)get_default_attribute_value(RAD$12);
            }
            return target;
        }
    }
    ...
    public boolean isSetRad()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(RAD$12) != null;
        }
    }
    ...
    public void setRad(long rad)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(RAD$12);
            }
    ...
    public void xsetRad(org.openxmlformats.schemas.drawingml.x2006.main.STPositiveCoordinate rad)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.main.STPositiveCoordinate)get_store().add_attribute_user(RAD$12);
            }
            target.set(rad);
        }
    }
