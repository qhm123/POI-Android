 ...
 */
public class CTStyleMatrixReferenceImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.main.CTStyleMatrixReference
{
    
    public CTStyleMatrixReferenceImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public org.openxmlformats.schemas.drawingml.x2006.main.STStyleMatrixColumnIndex xgetIdx()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.drawingml.x2006.main.STStyleMatrixColumnIndex target = null;
            target = (org.openxmlformats.schemas.drawingml.x2006.main.STStyleMatrixColumnIndex)get_store().find_attribute_user(IDX$12);
            return target;
        }
    }
     ...
     */
    public void xsetIdx(org.openxmlformats.schemas.drawingml.x2006.main.STStyleMatrixColumnIndex idx)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.main.STStyleMatrixColumnIndex)get_store().add_attribute_user(IDX$12);
            }
            target.set(idx);
        }
    }
