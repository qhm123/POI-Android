...
public class CTPresetShadowEffectImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.main.CTPresetShadowEffect
{
    ...
    private static final javax.xml.namespace.QName PRST$12 = 
    ...
    public org.openxmlformats.schemas.drawingml.x2006.main.STPresetShadowVal.Enum getPrst()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(PRST$12);
            if (target == null)
            {
                return null;
            }
            return (org.openxmlformats.schemas.drawingml.x2006.main.STPresetShadowVal.Enum)target.getEnumValue();
        }
    }
    ...
    public org.openxmlformats.schemas.drawingml.x2006.main.STPresetShadowVal xgetPrst()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.main.STPresetShadowVal)get_store().find_attribute_user(PRST$12);
            return target;
        }
    }
    ...
    public void setPrst(org.openxmlformats.schemas.drawingml.x2006.main.STPresetShadowVal.Enum prst)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(PRST$12);
            }
    ...
    public void xsetPrst(org.openxmlformats.schemas.drawingml.x2006.main.STPresetShadowVal prst)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.main.STPresetShadowVal)get_store().add_attribute_user(PRST$12);
            }
            target.set(prst);
        }
    }
