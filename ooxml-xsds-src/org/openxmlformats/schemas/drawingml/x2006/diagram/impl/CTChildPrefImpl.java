...
public class CTChildPrefImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.diagram.CTChildPref
{
    ...
    public org.openxmlformats.schemas.drawingml.x2006.diagram.STNodeCount xgetVal()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.diagram.STNodeCount)get_store().find_attribute_user(VAL$0);
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.diagram.STNodeCount)get_default_attribute_value(VAL$0);
            }
            return target;
        }
    }
    ...
    public void xsetVal(org.openxmlformats.schemas.drawingml.x2006.diagram.STNodeCount val)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.diagram.STNodeCount)get_store().add_attribute_user(VAL$0);
            }
            target.set(val);
        }
    }
