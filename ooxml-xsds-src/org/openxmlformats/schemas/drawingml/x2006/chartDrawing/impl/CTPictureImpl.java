...
public class CTPictureImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.chartDrawing.CTPicture
{
    ...
    private static final javax.xml.namespace.QName NVPICPR$0 = 
        new javax.xml.namespace.QName("http://schemas.openxmlformats.org/drawingml/2006/chartDrawing", "nvPicPr");
    private static final javax.xml.namespace.QName BLIPFILL$2 = 
        new javax.xml.namespace.QName("http://schemas.openxmlformats.org/drawingml/2006/chartDrawing", "blipFill");
    ...
    public org.openxmlformats.schemas.drawingml.x2006.chartDrawing.CTPictureNonVisual getNvPicPr()
    {
        synchronized (monitor())
        {
            ...
            target = (org.openxmlformats.schemas.drawingml.x2006.chartDrawing.CTPictureNonVisual)get_store().find_element_user(NVPICPR$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public void setNvPicPr(org.openxmlformats.schemas.drawingml.x2006.chartDrawing.CTPictureNonVisual nvPicPr)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.chartDrawing.CTPictureNonVisual)get_store().add_element_user(NVPICPR$0);
            }
            target.set(nvPicPr);
        }
    }
