 ...
 */
public class CTRelSizeAnchorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.chartDrawing.CTRelSizeAnchor
{
    
    public CTRelSizeAnchorImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName TO$2 = 
        new javax.xml.namespace.QName("http://schemas.openxmlformats.org/drawingml/2006/chartDrawing", "to");
     ...
     * Gets the "to" element
     */
    public org.openxmlformats.schemas.drawingml.x2006.chartDrawing.CTMarker getTo()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.drawingml.x2006.chartDrawing.CTMarker target = null;
            target = (org.openxmlformats.schemas.drawingml.x2006.chartDrawing.CTMarker)get_store().find_element_user(TO$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     * Sets the "to" element
     */
    public void setTo(org.openxmlformats.schemas.drawingml.x2006.chartDrawing.CTMarker to)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.chartDrawing.CTMarker)get_store().add_element_user(TO$2);
            }
            target.set(to);
        }
    }
     ...
     */
    public org.openxmlformats.schemas.drawingml.x2006.chartDrawing.CTMarker addNewTo()
    {
        synchronized (monitor())
        {
            check_orphaned();
