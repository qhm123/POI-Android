 ...
 */
public class CTConnectorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.openxmlformats.schemas.drawingml.x2006.spreadsheetDrawing.CTConnector
{
    ...
    private static final javax.xml.namespace.QName NVCXNSPPR$0 = 
        new javax.xml.namespace.QName("http://schemas.openxmlformats.org/drawingml/2006/spreadsheetDrawing", "nvCxnSpPr");
     ...
     */
    public org.openxmlformats.schemas.drawingml.x2006.spreadsheetDrawing.CTConnectorNonVisual getNvCxnSpPr()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.openxmlformats.schemas.drawingml.x2006.spreadsheetDrawing.CTConnectorNonVisual target = null;
            target = (org.openxmlformats.schemas.drawingml.x2006.spreadsheetDrawing.CTConnectorNonVisual)get_store().find_element_user(NVCXNSPPR$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setNvCxnSpPr(org.openxmlformats.schemas.drawingml.x2006.spreadsheetDrawing.CTConnectorNonVisual nvCxnSpPr)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (org.openxmlformats.schemas.drawingml.x2006.spreadsheetDrawing.CTConnectorNonVisual)get_store().add_element_user(NVCXNSPPR$0);
            }
     ...
     */
    public org.openxmlformats.schemas.drawingml.x2006.spreadsheetDrawing.CTConnectorNonVisual addNewNvCxnSpPr()
    {
        synchronized (monitor())
        {
            check_orphaned();
